...
Public Class clsCtrl
   ...
   Private Function WhereFilterGet() As String
      ...
      Select Case mintWhereFilter
         ...
         Case WhereFilters.CtrlType
            strSQL = " WHERE  secCtrl.CtrlType = " & StringToField(mstrCtrlType)

         Case WhereFilters.LIKECtrlType
            strSQL = " WHERE  secCtrl.CtrlType LIKE " & StringToField(mstrCtrlType & LikeOperator)

         Case WhereFilters.Grid
            strSQL = " WHERE  secCtrl.AppId = " & NumberToField(mlngAppId)
            strSQL &= " AND  secCtrl.FormId = secCtrl.FormId "
   ...
   Private Function OrderByFilterGet() As String
      ...
      Select Case mintOrderByFilter
         ...
         Case OrderByFilters.CtrlType
            strSQL = " ORDER BY secCtrl.CtrlType"
      ...
      Try
         ...
         Select Case mintSelectFilter
            Case SelectFilters.All
               ...
               'mstrCtrlText = ToLong(oDataRow("PlanId"))
   ...
   Public Function NoDuplicates(ByVal boolReplace As Boolean) As Boolean
      ...
      Try
         ...
         '   strSQL &= " WHERE  secCtrl.CtrlType = " & StringToField(mstrCtrlType)
         '   strSQL &= " AND  secCtrl.AppId = " & NumberToField(mlngAppId)
         'Else
         '   strSQL &= " WHERE  secCtrl.CtrlType = " & StringToField(mstrCtrlType)
         '   strSQL &= " AND  secCtrl.AppId = " & NumberToField(mlngAppId)
