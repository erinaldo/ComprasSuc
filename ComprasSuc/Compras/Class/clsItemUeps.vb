...
Public Class clsItemUeps
   Implements IDisposable

   Private mlngItemUepsId As Long
   ...
   '******************************************************
   Property ItemUepsId() As Long
      Get
         Return mlngItemUepsId
      End Get

      Set(ByVal Value As Long)
         mlngItemUepsId = Value
      End Set
   End Property
   ...
   '************************************************************
   Public Sub New()
      mstrTableName = "invItemUeps"
      mstrClassName = "clsItemUeps"
   ...
   Private Function SelectSQL() As String
      ...
      Select Case mintSelectFilter
         Case SelectFilters.All
            strSQL = " SELECT  "
            strSQL &= "    invItemUeps.ItemUepsId,  "
            strSQL &= "    invItemUeps.EmpresaId,  "
            strSQL &= "    invItemUeps.GestionId,  "
            strSQL &= "    invItemUeps.AlmacenId,  "
            strSQL &= "    invItemUeps.NotaId,  "
            strSQL &= "    invItemUeps.NotaDetId,  "
            strSQL &= "    invItemUeps.ItemId,  "
            strSQL &= "    invItemUeps.Fecha,  "
            strSQL &= "    invItemUeps.FechaNro,  "
            strSQL &= "    invItemUeps.Precio,  "
            strSQL &= "    invItemUeps.Saldo,  "
            strSQL &= "    invItemUeps.sLastUpdate_id,  "
            strSQL &= "    invItemUeps.dtLastUpdate_dt,  "
            strSQL &= "    invItemUeps.iConcurrency_id  "
            strSQL &= " FROM invItemUeps "
   ...
   Private Function WhereFilterGet() As String
      ...
      Select Case mintWhereFilter
         Case WhereFilters.PrimaryKey
            strSQL = " WHERE  invItemUeps.ItemUepsId = " & NumberToField(mlngItemUepsId)
         ...
         Case WhereFilters.EmpresaId
            strSQL = " WHERE  invItemUeps.EmpresaId = " & NumberToField(mlngEmpresaId)

         Case WhereFilters.ItemId
            strSQL = " WHERE  invItemUeps.EmpresaId = " & NumberToField(mlngEmpresaId)
            strSQL &= " AND  invItemUeps.GestionId = " & NumberToField(mlngGestionId)
            strSQL &= " AND  invItemUeps.AlmacenId = " & NumberToField(mlngAlmacenId)
            strSQL &= " AND  invItemUeps.ItemId = " & NumberToField(mlngItemId)
         ...
         Case WhereFilters.Fecha
            ...
            strSQL &= " AND  invItemUeps.AlmacenId = " & NumberToField(mlngAlmacenId)
            strSQL &= " AND  invItemUeps.ItemId = " & NumberToField(mlngItemId)
            strSQL &= " AND  invItemUeps.Fecha = " & DateToField(mstrFecha)

         Case WhereFilters.NotaDetId
            strSQL = " WHERE  invItemUeps.EmpresaId = " & NumberToField(mlngEmpresaId)
            strSQL &= " AND  invItemUeps.NotaDetId = " & NumberToField(mlngNotaDetId)
   ...
   Private Function OrderByFilterGet() As String
      ...
      Select Case mintOrderByFilter
         Case OrderByFilters.ItemUepsId
            strSQL = " ORDER BY invItemUeps.ItemUepsId "
         ...
         Case OrderByFilters.Fecha
            strSQL = " ORDER BY invItemUeps.Fecha DESC, invItemUeps.FechaNro DESC "
   ...
   Private Function InsertSQL() As String
      ...
      Select Case mintInsertFilter
         Case InsertFilters.All
            strSQL = "INSERT INTO invItemUeps ("
            strSQL &= "ItemUepsId, "
            strSQL &= "EmpresaId, "
            strSQL &= "GestionId, "
            strSQL &= "AlmacenId, "
            ...
            strSQL &= ConcurInsert()
            strSQL &= ") VALUES ("
            strSQL &= NumberToField(mlngItemUepsId) & ", "
   ...
   Private Function UpdateSQL() As String
      ...
      Select Case mintUpdateFilter
         Case UpdateFilters.All
            ...
            strSQL &= " WHERE "
            strSQL &= " ItemUepsId = " & NumberToField(mlngItemUepsId) & " "
   ...
   Private Sub Retrieve(ByVal oDataRow As DataRow)
      Try
         ...
         Select Case mintSelectFilter
            Case SelectFilters.All
               mlngItemUepsId = ToLong(oDataRow("ItemUepsId"))
   ...
   Private Function GetNewPrimaryKey() As Boolean
      Try
         ...
         mlngItemUepsId = TableIDGet(mstrTableName, "ItemUepsId", moConnection)

         If mlngItemUepsId = -1 Then
   ...
   Public Function Validate() As Boolean
      ...
      If mlngNotaId = 0 Then
         strMsg &= "Nota Inválida" & vbCrLf
      End If

      If mlngNotaDetId = 0 Then
         strMsg &= "Detalle de Nota Inválida" & vbCrLf
      End If
   ...
   Public Function NoDuplicates(ByVal boolReplace As Boolean) As Boolean
      ...
      Try
         ...
         '   strSQL &= " WHERE  invItemUeps.EmpresaId = " & NumberToField(mlngEmpresaId)
         '   strSQL &= " AND  invItemUeps.TipoNotaId = " & NumberToField(mlngTipoNotaId)
         'Else
         '   strSQL &= " WHERE  invItemUeps.EmpresaId = " & NumberToField(mlngEmpresaId)
         '   strSQL &= " AND  invItemUeps.TipoNotaId = " & NumberToField(mlngTipoNotaId)
         '   strSQL &= " AND  invItemUeps.ItemUepsId <> " & NumberToField(mlngItemUepsId)
         'End If
