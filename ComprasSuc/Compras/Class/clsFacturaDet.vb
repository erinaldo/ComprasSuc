...
Public Class clsFacturaDet
   ...
   Private mlngFacturaDetId As Long
   ...
   '******************************************************
   Property FacturaDetId() As Long
      Get
         Return mlngFacturaDetId
      End Get

      Set(ByVal Value As Long)
         mlngFacturaDetId = Value
      End Set
   End Property
   ...
   '************************************************************
   Public Sub New()
      mstrTableName = "tblFacturaDet"
      mstrClassName = "clsFacturaDet"
   ...
   Private Function SelectSQL() As String
      ...
      Select Case mintSelectFilter
         Case SelectFilters.All
            strSQL = " SELECT  "
            strSQL &= "    tblFacturaDet.FacturaDetId,  "
            strSQL &= "    tblFacturaDet.EmpresaId,  "
            strSQL &= "    tblFacturaDet.GestionId,  "
            strSQL &= "    tblFacturaDet.FacturaId,  "
            ...
            strSQL &= "    tblFacturaDet.EstadoId,  "
            strSQL &= "    tblFacturaDet.sLastUpdate_id,  "
            strSQL &= "    tblFacturaDet.dtLastUpdate_dt,  "
            strSQL &= "    tblFacturaDet.iConcurrency_id  "
            strSQL &= " FROM tblFacturaDet "
         ...
         Case SelectFilters.Grid
            ...
            strSQL &= "    tblFacturaDet.Precio,  "
            strSQL &= "    tblFacturaDet.Importe  "
            strSQL &= " FROM tblFacturaDet, invItem, invMedida "
   ...
   Private Function WhereFilterGet() As String
      ...
      Select Case mintWhereFilter
         Case WhereFilters.PrimaryKey
            strSQL = " WHERE  tblFacturaDet.FacturaDetId = " & NumberToField(mlngFacturaDetId)

         Case WhereFilters.Grid
            strSQL = " WHERE  tblFacturaDet.EmpresaId = " & NumberToField(mlngEmpresaId)
            strSQL &= " AND  tblFacturaDet.FacturaId = " & NumberToField(mlngFacturaId)
            strSQL &= " AND  tblFacturaDet.ItemId = invItem.ItemId "
            strSQL &= " AND  tblFacturaDet.MedidaId = invMedida.MedidaId "

         Case WhereFilters.Report

         Case WhereFilters.FacturaId
            strSQL = " WHERE  tblFacturaDet.FacturaId = " & NumberToField(mlngFacturaId)
   ...
   Private Function OrderByFilterGet() As String
      ...
      Select Case mintOrderByFilter
         Case OrderByFilters.FacturaDetId
            strSQL = " ORDER BY tblFacturaDet.FacturaDetId "
   ...
   Private Function InsertSQL() As String
      ...
      Select Case mintInsertFilter
         Case InsertFilters.All
            strSQL = "INSERT INTO tblFacturaDet ("
            strSQL &= "FacturaDetId, "
            strSQL &= "EmpresaId, "
            strSQL &= "GestionId, "
            strSQL &= "FacturaId, "
            ...
            strSQL &= ConcurInsert()
            strSQL &= ") VALUES ("
            strSQL &= NumberToField(mlngFacturaDetId) & ", "
   ...
   Private Function UpdateSQL() As String
      ...
      Select Case mintUpdateFilter
         Case UpdateFilters.All
            strSQL = "UPDATE tblFacturaDet SET "
            ...
            strSQL &= " WHERE "
            strSQL &= " FacturaDetId = " & NumberToField(mlngFacturaDetId) & " "
   ...
   Private Sub Retrieve(ByVal oDataRow As DataRow)
      Try
         ...
         Select Case mintSelectFilter
            Case SelectFilters.All
               mlngFacturaDetId = ToLong(oDataRow("FacturaDetId"))
   ...
   Private Function GetNewPrimaryKey() As Boolean
      Try
         ...
         mlngFacturaDetId = TableIDGet(mstrTableName, "FacturaDetId", moConnection)

         If mlngFacturaDetId = -1 Then
   ...
   Public Function Validate() As Boolean
      ...
      If mlngFacturaId = 0 Then
         strMsg &= "Seleccione el Tipo de FacturaDetrobante" & vbCrLf
      End If
   ...
   Public Function NoDuplicates(ByVal boolReplace As Boolean) As Boolean
      ...
      Try
         ...
         '   strSQL &= " WHERE  tblFacturaDet.EmpresaId = " & NumberToField(mlngEmpresaId)
         '   strSQL &= " AND  tblFacturaDet.TipoFacturaId = " & NumberToField(mlngTipoFacturaId)
         'Else
         '   strSQL &= " WHERE  tblFacturaDet.EmpresaId = " & NumberToField(mlngEmpresaId)
         '   strSQL &= " AND  tblFacturaDet.TipoFacturaId = " & NumberToField(mlngTipoFacturaId)
         '   strSQL &= " AND  tblFacturaDet.FacturaDetId <> " & NumberToField(mlngFacturaDetId)
         'End If
