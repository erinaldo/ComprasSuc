Public Class frmCompraMovResuCC
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompraMovResuCC))
...
#End Region
   ...
   Private Sub frmCompraMovResuCC_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompraMovResuCC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
               ...
               For Each lngItemId As Long In moLista
                  ...
                  If .FindByPK Then
                     ...
                     With oCompraDet
                        ...
                        .ItemId = lngItemId
                        .CompraDetDes = mstrConsultaCC
                        .SucursalIdAct = mlngSucursalId

                        If mboolIntervaloFecha Then
                           .WhereFilter = clsCompraDet.WhereFilters.SaldoCCFecha
                           .Fecha = mstrFechaIni
                           .LastUpdateDate = mstrFechaFin
                        Else
                           .WhereFilter = clsCompraDet.WhereFilters.SaldoCCActual
                        End If
   ...
   Private Function ItemCantidadFecha(ByVal lngItemId As Long, ByVal lngAlmacenId As Long, ByRef decImporteOrg As Decimal, ByRef decImporteCos As Decimal) As Decimal
      ...
      Try
         With oCompraDet
            .SelectFilter = clsCompraDet.SelectFilters.All
            .WhereFilter = clsCompraDet.WhereFilters.SaldoCCFechaIgual
            .EmpresaId = mlngEmpresaId
            .GestionId = mlngGestionId
            .AlmacenId = mlngAlmacenId
            .ProveedorId = mlngProveedorId
   ...
   Private Function TieneMovimiento(ByVal lngItemId As Long) As Boolean
      ...
      Try
         With oCompraDet
            ...
            If mboolIntervaloFecha Then
               .WhereFilter = clsCompraDet.WhereFilters.TieneMovimientoCCFecha
               .Fecha = mstrFechaIni
               .LastUpdateDate = mstrFechaFin
            Else
               .WhereFilter = clsCompraDet.WhereFilters.TieneMovimientoCC
            End If
   ...
   Private Sub frmCompraMovResuCC_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCompraMovResuCC_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moItem.Dispose()
      Call ClearMemory()
   End Sub
