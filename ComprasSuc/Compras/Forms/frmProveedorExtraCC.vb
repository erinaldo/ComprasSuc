Public Class frmProveedorExtraCC
   ...
   Private mdecDebeCli As Decimal
   Private mdecHaberCli As Decimal
   Private mdecSaldoCli As Decimal
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmProveedorExtraCC))
...
#End Region
   ...
   Private Sub frmProveedorExtraCC_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmProveedorExtraCC_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
               ...
               For Each lngCentroCostoId As Long In moListaCC
                  ...
                  If TieneMovimiento(lngProveedorId, lngCentroCostoId) Then
                     ...
                     If Not mboolSaldoCero Then
                        If ProveedoresaldoActual(lngProveedorId, lngCentroCostoId) <> 0 Then
                     ...
                     mdecDebeCli = mdecDebeCli + mdecDebe
                     mdecHaberCli = mdecHaberCli + mdecHaber
                     mdecSaldoCli = mdecSaldoCli + mdecSaldo
   ...
   Private Sub GetMovimiento(ByVal lngProveedorId As Long, ByVal lngCentroCostoId As Long)
      ...
      With moProveedorMov
         ...
         If .Open() Then
            ...
            If mboolIntervaloFecha Then
               mdecSaldo = ProveedoresaldoAnterior(.ProveedorId, .CentroCostoId)
            Else
               mdecSaldo = 0
            End If
   ...
   Private Function GetRow(ByVal oDataRow As DataRow, ByRef decInteres As Decimal) As DataRow
      ...
      ''mdecSaldo += ToDecimal(oRow("Debe") - oRow("Haber"))
   ...
   Private Function GetFooter() As DataRow
      ...
      oRow("Debe") = mdecDebeCli
      oRow("Haber") = mdecHaberCli
      oRow("Saldo") = mdecSaldoCli
   ...
   Private Function GetFooterCC() As DataRow
      ...
      oRow("ProveedorMovId") = -2
      oRow("ProveedorMovDes") = " SubTotal C. C. " & MonedaDesFind(mlngMonedaId) & " :"
      oRow("Debe") = mdecDebe
   ...
   Private Function ProveedoresaldoAnterior(ByVal lngProveedorId As Long, ByVal lngCentroCostoId As Long) As Decimal
      ...
      Try
         With oProveedorMov
            ...
            ''ProveedoresaldoAnterior = ToDecimal(decDebe - decHaber)
   ...
   Private Function ProveedoresaldoIntervalo(ByVal lngProveedorId As Long, ByVal lngCentroCostoId As Long) As Decimal
      Dim oProveedorMov As New clsProveedorMov(clsAppInfo.ConnectString)
      Dim decDebe As Decimal = 0
      Dim decHaber As Decimal = 0
      ...
      Try
         With oProveedorMov
            ...
            ''ProveedoresaldoIntervalo = ToDecimal(decDebe - decHaber)
   ...
   Private Function ProveedoresaldoActual(ByVal lngProveedorId As Long, ByVal lngCentroCostoId As Long) As Decimal
      Dim oProveedorMov As New clsProveedorMov(clsAppInfo.ConnectString)
      Dim decDebe As Decimal = 0
      Dim decHaber As Decimal = 0
   ...
   Private Sub frmProveedorExtraCC_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmProveedorExtraCC_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
