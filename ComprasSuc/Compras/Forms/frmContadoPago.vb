...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmContadoPago))
...
#End Region
   ...
   Private Sub grdMainLoad()
      Try
         With moProveedor
            .SelectFilter = clsProveedor.SelectFilters.GridPagoContado
            .WhereFilter = clsProveedor.WhereFilters.GridPagoContado
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("EmpresaId")) > 0) Then
            With oCompra
               ...
               Dim frm As New frmContadoPagoEdit
   ...
   Private Sub PrintReport()
      ...
      rpt.lblTitle.Text = "Proveedores con Notas al Contado"
      rpt.Document.Name = "Proveedores con Notas al Contado"
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Pago de Notas al Contado"
         .ContextMenu = mnuMain
