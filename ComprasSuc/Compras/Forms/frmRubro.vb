...
#End Region
   ...
   Private Sub frmRubro_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmRubro_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moRubro
            .SelectFilter = clsRubro.SelectFilters.Grid
            .WhereFilter = clsRubro.WhereFilters.Grid
            .OrderByFilter = clsRubro.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("RubroId")) > 0) Then
            With oRubro
               .RubroId = ToLong(grdMain.GetValue("RubroId"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oRubro
                  .WhereFilter = clsRubro.WhereFilters.PrimaryKey
                  .RubroId = ToLong(grdMain.GetValue("RubroId"))
   ...
   Private Sub PrintReport()
      ...
      rpt.DataSource = GetDataView(moRubro.DataSet.Tables(moRubro.TableName))

      rpt.lblTitle.Text = "Rubros"
      rpt.Document.Name = "Rubros"
      rpt.lblProcedenciaCod.Text = "Código"
      rpt.txtProcedenciaCod.DataField = "RubroCod"

      rpt.lblProcedenciaDes.Text = "Rubro"
      rpt.txtProcedenciaDes.DataField = "RubroDes"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("RubroId")
   ...
   Private Sub FormInit()
      ...
      moRubro = New clsRubro(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Rubros"
         .ContextMenu = mnuMain

         .RootTable.Columns("RubroId").Visible = False

         .RootTable.Columns("RubroCod").Caption = "Código"
         .RootTable.Columns("RubroCod").Width = 150
         .RootTable.Columns("RubroCod").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("RubroCod").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("RubroDes").Caption = "Rubro"
         .RootTable.Columns("RubroDes").Width = 300
   ...
   Private Sub frmRubro_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmRubro_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moRubro.Dispose()
      Call ClearMemory()
   End Sub
