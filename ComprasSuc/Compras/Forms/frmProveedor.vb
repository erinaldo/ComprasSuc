...
#End Region
   ...
   Private Sub grdMainLoad()
      Try
         With moProveedor
            .SelectFilter = clsProveedor.SelectFilters.Grid
            .WhereFilter = clsProveedor.WhereFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("ProveedorId")) > 0) Then
            With oProveedor
               .ProveedorId = ToLong(grdMain.GetValue("ProveedorId"))
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oProveedor.EmpresaId = mlngEmpresaId
   ...
   Private Sub DataEdit()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If ToLong(grdMain.GetValue("ProveedorId")) > 0 Then
               With oProveedor
                  .ProveedorId = ToLong(grdMain.GetValue("ProveedorId"))
   ...
   Private Sub DataDelete()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If ToLong(grdMain.GetValue("ProveedorId")) > 0 Then
               If Not ProveedorMovFind(ToLong(grdMain.GetValue("ProveedorId"))) Then
                  If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                     With oProveedor
                        .WhereFilter = clsProveedor.WhereFilters.PrimaryKey
                        .ProveedorId = ToLong(grdMain.GetValue("ProveedorId"))
                  ...
                  End If
               Else
                  MessageBox.Show("Imposible Eliminar el Proveedor, Debido a que ya Tiene Movimiento", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            Else
               MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
   ...
   Private Function ProveedorMovFind(ByVal lngProveedorId As Long) As Boolean
      Dim oProveedor As New clsProveedor(clsAppInfo.ConnectString)

      Try
         With oProveedor
            .SelectFilter = clsProveedor.SelectFilters.ListBox
            .WhereFilter = clsProveedor.WhereFilters.ProveedorIdTieneMov
            .EmpresaId = mlngEmpresaId
   ...
   Private Sub PrintReport()
      ...
      rpt.DataSource = GetDataView(moProveedor.DataSet.Tables(moProveedor.TableName))

      rpt.lblTitle.Text = "Proveedores"
      rpt.Document.Name = "Proveedores"
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         If Not grdMainLayoutLoad(System.AppDomain.CurrentDomain.BaseDirectory() + "Layout\") Then
            ...
            .RootTable.Columns("PlanIdPas").Visible = False

            .RootTable.Columns("PlanDesPas").Caption = "Cuenta Pasivo"
            .RootTable.Columns("PlanDesPas").Width = 100
            .RootTable.Columns("PlanDesPas").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .RootTable.Columns("PlanDesPas").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("PlanAddIdPas").Visible = False

            .RootTable.Columns("PlanAddDesPas").Caption = "Anal. Adic."
            .RootTable.Columns("PlanAddDesPas").Width = 100
            .RootTable.Columns("PlanAddDesPas").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .RootTable.Columns("PlanAddDesPas").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("PlanIdAct").Visible = False

            .RootTable.Columns("PlanDesAct").Caption = "Cuenta Activo"
            .RootTable.Columns("PlanDesAct").Width = 100
            .RootTable.Columns("PlanDesAct").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .RootTable.Columns("PlanDesAct").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("PlanAddIdAct").Visible = False

            .RootTable.Columns("PlanAddDesAct").Caption = "Anal. Adic."
            .RootTable.Columns("PlanAddDesAct").Width = 100
            .RootTable.Columns("PlanAddDesAct").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .RootTable.Columns("PlanAddDesAct").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("PlanIdInt").Visible = False

            .RootTable.Columns("PlanDesInt").Caption = "Cuenta Interés"
            .RootTable.Columns("PlanDesInt").Width = 100
            .RootTable.Columns("PlanDesInt").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .RootTable.Columns("PlanDesInt").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("PlanAddIdInt").Visible = False

            .RootTable.Columns("PlanAddDesInt").Caption = "Anal. Adic."
            .RootTable.Columns("PlanAddDesInt").Width = 100
            .RootTable.Columns("PlanAddDesInt").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .RootTable.Columns("PlanAddDesInt").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("CreditoLimite").Caption = "Límite Cred."
            .RootTable.Columns("CreditoLimite").FormatString = DecimalMask()
            .RootTable.Columns("CreditoLimite").Width = 100
            .RootTable.Columns("CreditoLimite").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .RootTable.Columns("CreditoLimite").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("CreditoAuto").Caption = "Crédito Auto."
            .RootTable.Columns("CreditoAuto").Width = 100
            .RootTable.Columns("CreditoAuto").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
            .RootTable.Columns("CreditoAuto").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("CreditoDias").Caption = "Días Crédito"
            .RootTable.Columns("CreditoDias").Width = 100
            .RootTable.Columns("CreditoDias").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
            .RootTable.Columns("CreditoDias").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("InteresAnual").Caption = "Interés Anual"
            ...
            .RootTable.Columns("ProcedenciaDes").Width = 100
            ...
            .RootTable.Columns("RubroDes").Width = 100
   ...
   Private Sub frmProveedor_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmProveedor_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
