Public Class frmMedidaEdit
   Inherits System.Windows.Forms.Form

   Private moMedida As clsMedida
   ...
   WriteOnly Property DataObject() As clsMedida
      Set(ByVal Value As clsMedida)
         moMedida = Value
      End Set
   End Property
...
#Region " Windows Form Designer generated code "
   ...
   Friend WithEvents txtMedidaDes As Janus.Windows.GridEX.EditControls.EditBox
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmMedidaEdit))
      ...
      Me.txtMedidaDes = New Janus.Windows.GridEX.EditControls.EditBox
      ...
      Me.grpMain.Controls.Add(Me.txtMedidaDes)
      Me.grpMain.Controls.Add(Me.txtEmpresaId)
      Me.grpMain.Controls.Add(Me.txtMedidaId)
      ...
      'txtMedidaDes
      '
      Me.txtMedidaDes.ForeColor = System.Drawing.SystemColors.HotTrack
      Me.txtMedidaDes.Location = New System.Drawing.Point(116, 64)
      Me.txtMedidaDes.MaxLength = 100
      Me.txtMedidaDes.Name = "txtMedidaDes"
      Me.txtMedidaDes.Size = New System.Drawing.Size(320, 20)
      Me.txtMedidaDes.TabIndex = 2
      Me.txtMedidaDes.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
      Me.txtMedidaDes.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007
      '
      'txtEmpresaId
      '
...
#End Region
   ...
   Private Sub frmMedidaEdit_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmMedidaEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub FormShow()
      mboolShow = True
      With moMedida
         txtMedidaId.Text = ToStr(.MedidaId)
         Call txtEmpresaIdLoad(.EmpresaId)
         txtMedidaDes.Text = ToStr(.MedidaDes)
      End With
      mboolShow = False
   End Sub
   ...
   Private Sub DataClear()
      ...
      With moMedida
         ...
         Call txtEmpresaIdLoad(.EmpresaId)
         txtMedidaDes.Text = String.Empty
      End With
      mboolShow = False
   End Sub
   ...
   Private Sub DataMove()
      With moMedida
         If Not mboolAdding Then
            .MedidaId = ToLong(txtMedidaId.Text)
         End If

         .EmpresaId = ToLong(txtEmpresaId.Tag)
         .MedidaDes = ToStr(txtMedidaDes.Text)
      End With
   End Sub
   ...
   Private Sub frmMedidaEdit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmMedidaEdit_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moMedida.Dispose()
      Call ClearMemory()
   End Sub
