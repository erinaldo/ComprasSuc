Public Class frmGrupoEdit
   Inherits System.Windows.Forms.Form

   Private moGrupo As clsGrupo
   ...
   WriteOnly Property DataObject() As clsGrupo
...
#Region " Windows Form Designer generated code "
   ...
   Friend WithEvents txtGrupoDes As Janus.Windows.GridEX.EditControls.EditBox
   Friend WithEvents txtEmpresaId As Janus.Windows.GridEX.EditControls.EditBox
   Friend WithEvents txtGrupoId As Janus.Windows.GridEX.EditControls.EditBox
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmGrupoEdit))
      ...
      Me.txtGrupoDes = New Janus.Windows.GridEX.EditControls.EditBox
      Me.txtEmpresaId = New Janus.Windows.GridEX.EditControls.EditBox
      Me.txtGrupoId = New Janus.Windows.GridEX.EditControls.EditBox
      ...
      Me.grpMain.Controls.Add(Me.txtGrupoDes)
      Me.grpMain.Controls.Add(Me.txtEmpresaId)
      Me.grpMain.Controls.Add(Me.txtGrupoId)
      ...
      'txtGrupoDes
      '
      Me.txtGrupoDes.ForeColor = System.Drawing.SystemColors.HotTrack
      Me.txtGrupoDes.Location = New System.Drawing.Point(116, 88)
      Me.txtGrupoDes.MaxLength = 100
      Me.txtGrupoDes.Name = "txtGrupoDes"
      Me.txtGrupoDes.Size = New System.Drawing.Size(320, 20)
      Me.txtGrupoDes.TabIndex = 3
      Me.txtGrupoDes.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
      Me.txtGrupoDes.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007
      '
      'txtEmpresaId
      '
      ...
      'txtGrupoId
      '
      Me.txtGrupoId.ForeColor = System.Drawing.SystemColors.HotTrack
      Me.txtGrupoId.Location = New System.Drawing.Point(116, 16)
      Me.txtGrupoId.Name = "txtGrupoId"
      Me.txtGrupoId.ReadOnly = True
      Me.txtGrupoId.Size = New System.Drawing.Size(124, 20)
      Me.txtGrupoId.TabIndex = 0
      Me.txtGrupoId.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
      Me.txtGrupoId.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007
      '
      'Label4
      '
...
#End Region
   ...
   Private Sub frmGrupoEdit_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmGrupoEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub DataClear()
      ...
      With moGrupo
         ...
         Call txtEmpresaIdLoad(.EmpresaId)
         cboLinea.SelectedIndex = ListFindItem(cboLinea, .LineaId)
         txtGrupoDes.Text = String.Empty
      End With
      mboolShow = False
   End Sub

   Private Sub DataReadOnly()
      txtGrupoId.ReadOnly = True
      txtEmpresaId.ReadOnly = True
      cboLinea.ReadOnly = True
      txtGrupoDes.ReadOnly = True
   ...
   Private Sub FormInit()
      ...
      'txtGrupoId.MaxLength = 20
      'txtEmpresaId.MaxLength = 20
      'txtGrupoPadreId.MaxLength = 255
      'txtGrupoDes.MaxLength = 255
      'txtGrupoCta.MaxLength = 50
   ...
   Private Sub frmGrupoEdit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmGrupoEdit_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moGrupo.Dispose()
      Call ClearMemory()
   End Sub
