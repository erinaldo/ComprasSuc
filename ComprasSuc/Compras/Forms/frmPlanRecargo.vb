...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmPlanRecargo))
      ...
      Me.KeyPreview = True
      Me.Name = "frmPlanRecargo"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Tipos de Recargo"
...
#End Region
   ...
   Private Sub frmPlanRecargo_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmPlanRecargo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moPlanRecargo
            .SelectFilter = clsPlanRecargo.SelectFilters.Grid
            .WhereFilter = clsPlanRecargo.WhereFilters.Grid
            .OrderByFilter = clsPlanRecargo.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("PlanRecargoId")) > 0) Then
            With oPlanRecargo
               .PlanRecargoId = ToLong(grdMain.GetValue("PlanRecargoId"))

               If .FindByPK Then
                  Dim frm As New frmPlanRecargoEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oPlanRecargo
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oPlanRecargo.EmpresaId = mlngEmpresaId

            .DataObject = oPlanRecargo
            .ShowDialog()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oPlanRecargo
                  .WhereFilter = clsPlanRecargo.WhereFilters.PrimaryKey
                  .PlanRecargoId = ToLong(grdMain.GetValue("PlanRecargoId"))
   ...
   Private Sub PrintReport()
      ...
      rpt.DataSource = GetDataView(moPlanRecargo.DataSet.Tables(moPlanRecargo.TableName))

      rpt.lblTitle.Text = "Tipos de Recargo"
      rpt.Document.Name = "Tipos de Recargo"
      rpt.lblPlanDescuentoDes.Text = "Descripción Recargo"
      rpt.txtPlanDescuentoDes.DataField = "PlanRecargoDes"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("PlanRecargoId")
   ...
   Private Sub FormInit()
      ...
      moPlanRecargo = New clsPlanRecargo(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Tipos de Recargo"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("PlanRecargoDes").Caption = "Tipo Recargo"
         .RootTable.Columns("PlanRecargoDes").Width = 200
         ...
         .RootTable.Columns("PlanDes").Caption = "Cuenta Recargo"
   ...
   Private Sub frmPlanRecargo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmPlanRecargo_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
