Public Class frmDataBaseError
   ...
   WriteOnly Property ArrayColumName() As String()
      Set(ByVal Value As String())
         mArrayColumName = Value
      End Set
   End Property
...
#End Region
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .ContextMenu = mnuMain
         .RootTable.Columns("TablaId").Caption = mArrayColumName(0)
         .RootTable.Columns("TablaId").Width = 100
         .RootTable.Columns("TablaId").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("TablaId").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("TablaDetId").Caption = mArrayColumName(1)
         .RootTable.Columns("TablaDetId").Width = 100
         .RootTable.Columns("TablaDetId").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("TablaDetId").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("TablaNro").Caption = mArrayColumName(2)
         .RootTable.Columns("TablaNro").Width = 100
         .RootTable.Columns("TablaNro").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("TablaNro").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("TablaDes").Caption = mArrayColumName(3)
         ...
         .RootTable.Columns("DocumentoId").Caption = mArrayColumName(4)
         ...
         .RootTable.Columns("ErrorDes").Caption = mArrayColumName(5)
