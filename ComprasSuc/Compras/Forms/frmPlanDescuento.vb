...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmPlanDescuento))
      ...
      Me.KeyPreview = True
      Me.Name = "frmPlanDescuento"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Tipos de Descuento"
...
#End Region
   ...
   Private Sub frmPlanDescuento_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmPlanDescuento_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moPlanDescuento
            .SelectFilter = clsPlanDescuento.SelectFilters.Grid
            .WhereFilter = clsPlanDescuento.WhereFilters.Grid
            .OrderByFilter = clsPlanDescuento.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("PlanDescuentoId")) > 0) Then
            With oPlanDescuento
               .PlanDescuentoId = ToLong(grdMain.GetValue("PlanDescuentoId"))

               If .FindByPK Then
                  Dim frm As New frmPlanDescuentoEdit

                  frm.NewRecord = False
                  frm.Editing = False
                  frm.DataObject = oPlanDescuento
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oPlanDescuento.EmpresaId = mlngEmpresaId

            .DataObject = oPlanDescuento
            .ShowDialog()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oPlanDescuento
                  .WhereFilter = clsPlanDescuento.WhereFilters.PrimaryKey
                  .PlanDescuentoId = ToLong(grdMain.GetValue("PlanDescuentoId"))
   ...
   Private Sub PrintReport()
      ...
      rpt.DataSource = GetDataView(moPlanDescuento.DataSet.Tables(moPlanDescuento.TableName))

      rpt.lblTitle.Text = "Tipos de Descuento"
      rpt.Document.Name = "Tipos de Descuento"
      rpt.lblPlanDescuentoDes.Text = "Descripción Descuento"
      rpt.txtPlanDescuentoDes.DataField = "PlanDescuentoDes"

      rpt.lblPlanDes.Text = "Cuenta"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("PlanDescuentoId")
   ...
   Private Sub FormInit()
      ...
      moPlanDescuento = New clsPlanDescuento(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Tipos de Descuento"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("PlanDescuentoDes").Caption = "Tipo Descuento"
         .RootTable.Columns("PlanDescuentoDes").Width = 200
         ...
         .RootTable.Columns("PlanDes").Caption = "Cuenta Descuento"
   ...
   Private Sub frmPlanDescuento_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmPlanDescuento_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
