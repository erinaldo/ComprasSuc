...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.cdmMain.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New3, Me.Edit2, Me.Delete2, Me.ViewAll2, Me.Print2, Me.Exit3, Me.Refrescar, Me.Duplicate})
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New1, Me.Separator1, Me.Edit1, Me.Separator2, Me.Delete1, Me.Separator7, Me.Duplicate1, Me.Separator3, Me.Refrescar1, Me.Separator6, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
...
#End Region
   ...
   Private Sub grdMainLoad()
      Try
         With moItem
            .SelectFilter = clsItem.SelectFilters.Grid
            .WhereFilter = clsItem.WhereFilters.Grid
            .OrderByFilter = clsItem.OrderByFilters.Grid
   ...
   Private Sub DataDelete()
      ...
      Try
         If grdMain.RowCount > 0 Then
            ''If Not NotaDetFind(ToLong(grdMain.GetValue("ItemId"))) Then
            If Not ItemMovFind(ToLong(grdMain.GetValue("ItemId"))) Then
               If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                  With oItem
                     .WhereFilter = clsItem.WhereFilters.PrimaryKey
                     .ItemId = ToLong(grdMain.GetValue("ItemId"))

                     If .Delete Then
                        .CloseConection()

                        Call DatoTecnicoDelete(ToLong(grdMain.GetValue("ItemId")))
                        Call SustitutoDelete(ToLong(grdMain.GetValue("ItemId")))
                        Call ComposicionDelete(ToLong(grdMain.GetValue("ItemId")))
                        Call ItemPrecioDelete(ToLong(grdMain.GetValue("ItemId")))
               ...
               End If
            Else
               MessageBox.Show("Imposible Eliminar El Registro, Debido a que ya Tiene Movimiento", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
         Else
            MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
         End If
   ...
   Private Sub FormDuplicate()
      Dim oItem As New clsItem(clsAppInfo.ConnectString)
      Dim oItemClone As New clsItem(clsAppInfo.ConnectString)
         ...
         If grdMain.RowCount > 0 Then
            With oItem
               ...
               If .FindByPK Then
                  ...
                  oItemClone.EmpresaId = mlngEmpresaId
                  oItemClone.LineaId = .LineaId
                  oItemClone.GrupoId = .GrupoId
                  oItemClone.SubGrupoId = .SubGrupoId
                  oItemClone.MarcaId = .MarcaId
                  oItemClone.TipoItemId = .TipoItemId
                  oItemClone.FabricaId = .FabricaId
                  oItemClone.TipoCosteoId = .TipoCosteoId

                  oItemClone.CantidadMin = .CantidadMin
                  oItemClone.CantidadMax = .CantidadMax
                  oItemClone.MedidaId = .MedidaId
                  oItemClone.MedidaIdEqui = .MedidaIdEqui
                  oItemClone.MedidaCantEqui = .MedidaCantEqui
                  oItemClone.MonedaIdCos = .MonedaIdCos
                  oItemClone.MonedaIdVen = .MonedaIdVen
                  oItemClone.PlanGrupoId = .PlanGrupoId
                  oItemClone.ControlLote = .ControlLote
                  oItemClone.ControlSerie = .ControlSerie


                  frm.NewRecord = True
                  frm.Editing = False

                  frm.DataObject = oItemClone
                  frm.ShowDialog()
   ...
   Private Function DatoTecnicoDelete(ByVal lngItemId As Long) As Boolean
      Dim oDatoTecnico As New clsDatoTecnico(clsAppInfo.ConnectString)

      DatoTecnicoDelete = False

      Try
         With oDatoTecnico
            .WhereFilter = clsDatoTecnico.WhereFilters.ItemId
            .EmpresaId = mlngEmpresaId
            .ItemId = lngItemId

            If .Delete Then
               DatoTecnicoDelete = True
            End If
         End With
   ...
   Private Function SustitutoDelete(ByVal lngItemId As Long) As Boolean
      Dim oSustituto As New clsSustituto(clsAppInfo.ConnectString)

      SustitutoDelete = False

      Try
         With oSustituto
            .WhereFilter = clsSustituto.WhereFilters.ItemId
            .EmpresaId = mlngEmpresaId
            .ItemId = lngItemId

            If .Delete Then
               SustitutoDelete = True
            End If
         End With
   ...
   Private Function ComposicionDelete(ByVal lngItemId As Long) As Boolean
      Dim oComposicion As New clsComposicion(clsAppInfo.ConnectString)

      ComposicionDelete = False
   ...
   Private Function ItemPrecioDelete(ByVal lngItemId As Long) As Boolean
      Dim oItemPrecio As New clsItemPrecio(clsAppInfo.ConnectString)

      ItemPrecioDelete = False

      Try
         With oItemPrecio
            .DeleteFilter = clsItemPrecio.DeleteFilters.ItemId
            .EmpresaId = mlngEmpresaId
            .ItemId = lngItemId

            If .Delete Then
               ItemPrecioDelete = True
            End If
         End With
   ...
   Private Sub PrintReport()
      ...
      rpt.DataSource = GetDataView(moItem.DataSet.Tables(moItem.TableName))

      rpt.lblTitle.Text = "Ítems"
      rpt.Document.Name = "Ítems"
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         If Not grdMainLayoutLoad(System.AppDomain.CurrentDomain.BaseDirectory() + "Layout\") Then
            ...
            .RootTable.Columns("Imagen").Caption = "Imagen"
            .RootTable.Columns("Imagen").Width = 100
            .RootTable.Columns("Imagen").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .RootTable.Columns("Imagen").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
            ...
            .RootTable.Columns("TipoItemDes").Caption = "Tipo Item"
            ...
            .RootTable.Columns("ControlLote").Caption = "Lote"
            .RootTable.Columns("ControlLote").Width = 50
            .RootTable.Columns("ControlLote").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
            .RootTable.Columns("ControlLote").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("ControlSerie").Caption = "Serie"
            .RootTable.Columns("ControlSerie").Width = 50
            .RootTable.Columns("ControlSerie").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
            .RootTable.Columns("ControlSerie").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("CantidadMin").Caption = "Cantidad Min"
            .RootTable.Columns("CantidadMin").FormatString = DecimalMask()
            .RootTable.Columns("CantidadMin").Width = 100
            .RootTable.Columns("CantidadMin").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .RootTable.Columns("CantidadMin").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("CantidadMax").Caption = "Cantidad Max"
            .RootTable.Columns("CantidadMax").FormatString = DecimalMask()
            .RootTable.Columns("CantidadMax").Width = 100
            .RootTable.Columns("CantidadMax").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .RootTable.Columns("CantidadMax").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
            ...
            .RootTable.Columns("TipoTasaId").Visible = False

            .RootTable.Columns("TipoTasaDes").Caption = "Tipo Tasa"
            .RootTable.Columns("TipoTasaDes").Width = 100
            .RootTable.Columns("TipoTasaDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .RootTable.Columns("TipoTasaDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("TipoTasaMonto").Caption = "Tasa Monto."
            .RootTable.Columns("TipoTasaMonto").FormatString = DecimalMask()
            .RootTable.Columns("TipoTasaMonto").Width = 100
            .RootTable.Columns("TipoTasaMonto").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .RootTable.Columns("TipoTasaMonto").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("PlanGrupoId").Visible = False

            .RootTable.Columns("PlanGrupoDes").Caption = "Grupo Cuenta"
            ...
            .RootTable.Columns("Comision").Caption = "% Comision"
            .RootTable.Columns("Comision").FormatString = DecimalMask()
            .RootTable.Columns("Comision").Width = 100
            .RootTable.Columns("Comision").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .RootTable.Columns("Comision").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("Utilidad").Caption = "% Utilidad"
            .RootTable.Columns("Utilidad").FormatString = DecimalMask()
            .RootTable.Columns("Utilidad").Width = 100
            .RootTable.Columns("Utilidad").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
            .RootTable.Columns("Utilidad").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

            .RootTable.Columns("Obs").Caption = "Observación"
            .RootTable.Columns("Obs").Width = 100
            .RootTable.Columns("Obs").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
            .RootTable.Columns("Obs").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
   ...
   Private Sub frmItem_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmItem_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
