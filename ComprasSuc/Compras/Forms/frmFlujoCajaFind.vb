...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmFlujoCajaFind))
      ...
      Me.bcgMain.Size = New System.Drawing.Size(412, 203)
      ...
      Me.UiGroupBox2.Size = New System.Drawing.Size(396, 116)
      ...
      Me.cboCentroCosto.Size = New System.Drawing.Size(316, 20)
      Me.cboCentroCosto.TabIndex = 172
      ...
      Me.lblCentroCosto.Location = New System.Drawing.Point(9, 62)
      ...
      Me.cboMoneda.Location = New System.Drawing.Point(72, 12)
      Me.cboMoneda.Name = "cboMoneda"
      Me.cboMoneda.SelectedItemFormatStyle.ForeColor = System.Drawing.Color.White
      Me.cboMoneda.Size = New System.Drawing.Size(316, 20)
      ...
      Me.cboProveedor.Size = New System.Drawing.Size(316, 20)
      ...
      Me.cboSucursal.Location = New System.Drawing.Point(72, 84)
      Me.cboSucursal.Name = "cboSucursal"
      Me.cboSucursal.SelectedItemFormatStyle.ForeColor = System.Drawing.Color.White
      Me.cboSucursal.Size = New System.Drawing.Size(316, 20)
      ...
      Me.Name = "frmFlujoCajaFind"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Criterios Flujo de Caja de Compras"
...
#End Region
   ...
   Private Sub frmFlujoCajaFind_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmFlujoCajaFind_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub cboProveedor_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cboProveedor.SelectedIndexChanged
      If ListPosition(cboProveedor, cboProveedor.SelectedIndex) <> 0 Then
   ...
   Private Sub frmFlujoCajaFind_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmFlujoCajaFind_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moItem.Dispose()
      Call ClearMemory()
   End Sub
