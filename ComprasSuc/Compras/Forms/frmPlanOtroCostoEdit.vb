Public Class frmPlanOtroCostoEdit
   Inherits System.Windows.Forms.Form

   Private moPlanOtroCosto As clsPlanOtroCosto
   ...
   WriteOnly Property DataObject() As clsPlanOtroCosto
      Set(ByVal Value As clsPlanOtroCosto)
         moPlanOtroCosto = Value
      End Set
   End Property
...
#Region " Windows Form Designer generated code "
   ...
   Friend WithEvents txtPlanOtroCostoDes As Janus.Windows.GridEX.EditControls.EditBox
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmPlanOtroCostoEdit))
      ...
      Me.txtPlanOtroCostoDes = New Janus.Windows.GridEX.EditControls.EditBox
      ...
      Me.grpMain.Controls.Add(Me.txtPlanOtroCostoDes)
      ...
      Me.lblActivo.Text = "Cuenta"
      '
      'txtPlanOtroCostoDes
      '
      Me.txtPlanOtroCostoDes.ForeColor = System.Drawing.SystemColors.HotTrack
      Me.txtPlanOtroCostoDes.Location = New System.Drawing.Point(116, 40)
      Me.txtPlanOtroCostoDes.MaxLength = 255
      Me.txtPlanOtroCostoDes.Name = "txtPlanOtroCostoDes"
      Me.txtPlanOtroCostoDes.Size = New System.Drawing.Size(320, 20)
      Me.txtPlanOtroCostoDes.TabIndex = 1
      Me.txtPlanOtroCostoDes.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
      Me.txtPlanOtroCostoDes.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007
      '
      'txtPlanOtroCostoId
      '
      Me.txtPlanOtroCostoId.ForeColor = System.Drawing.SystemColors.HotTrack
      Me.txtPlanOtroCostoId.Location = New System.Drawing.Point(116, 16)
      Me.txtPlanOtroCostoId.Name = "txtPlanOtroCostoId"
      Me.txtPlanOtroCostoId.ReadOnly = True
      Me.txtPlanOtroCostoId.Size = New System.Drawing.Size(124, 20)
      Me.txtPlanOtroCostoId.TabIndex = 0
      ...
      Me.Name = "frmPlanOtroCostoEdit"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "PlanOtroCosto Edit"
...
#End Region
   ...
   Private Sub cdmMain_CommandClick(ByVal sender As System.Object, ByVal e As Janus.Windows.UI.CommandBars.CommandEventArgs) Handles cdmMain.CommandClick
      ...
      Select Case e.Command.Key
         Case "Save"
            If DataSave() Then
               mlngID = moPlanOtroCosto.PlanOtroCostoId
               mboolChanged = True
               Me.Close()
            End If
   ...
   Private Sub frmPlanOtroCostoEdit_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmPlanOtroCostoEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
      ...
      If Not mboolAdding Then
         ...
         If Not mboolEditing Then
            Call DataReadOnly()
            Me.Text = "Consulta Otro Costo Aplicable"
         Else
            Me.Text = "Editar Otro Costo Aplicable"
         End If
      Else
         Me.Text = "Nuevo Otro Costo Aplicable"
         Call FormNew()
      End If
   ...
   Private Sub FormShow()
      mboolShow = True
      With moPlanOtroCosto
         txtPlanOtroCostoId.Text = ToStr(.PlanOtroCostoId)
         txtPlanOtroCostoDes.Text = ToStr(.PlanOtroCostoDes)
   ...
   Private Sub DataClear()
      mboolShow = True
      With moPlanOtroCosto
         txtPlanOtroCostoId.Text = String.Empty
         txtPlanOtroCostoDes.Text = String.Empty
   ...
   Private Sub DataReadOnly()
      ...
      txtPlanOtroCostoDes.ReadOnly = True
   ...
   Private Sub DataMove()
      With moPlanOtroCosto
         If Not mboolAdding Then
            .PlanOtroCostoId = ToLong(txtPlanOtroCostoId.Text)
         End If

         .PlanOtroCostoDes = ToStr(txtPlanOtroCostoDes.Text)
   ...
   Private Function DataAdd() As Boolean
      Try
         ...
         If moPlanOtroCosto.Insert() Then
            mboolAdding = False
            DataAdd = True
         End If
   ...
   Private Function DataUpdate() As Boolean
      Try
         ...
         If moPlanOtroCosto.Update() Then
            DataUpdate = True
         End If
   ...
   Private Sub cboPlanLoad()
      ...
      Try
         With oPlan
            ...
            .EmpresaId = moPlanOtroCosto.EmpresaId
            .EsAna = 1
            .PlanId = moPlanOtroCosto.PlanId
   ...
   Private Sub frmPlanOtroCostoEdit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmPlanOtroCostoEdit_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlanOtroCosto.Dispose()
      Call ClearMemory()
   End Sub
