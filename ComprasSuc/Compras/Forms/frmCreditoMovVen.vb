...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCreditoMovVen))
      ...
      Me.KeyPreview = True
      Me.Name = "frmCreditoMovVen"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Estado de Creditos"
...
#End Region
   ...
   Private Sub cdmMain_CommandClick(ByVal sender As System.Object, ByVal e As Janus.Windows.UI.CommandBars.CommandEventArgs) Handles cdmMain.CommandClick
      ...
      Select Case e.Command.Key
         Case "Book"
            If ToLong(grdMain.GetValue("TipoId")) = 2 Then
               Call frmCreditoEditLoad()

            ElseIf ToLong(grdMain.GetValue("TipoId")) = 3 Then
   ...
   Private Sub frmCreditoDet_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCreditoDet_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      ...
      Dim oRow As DataRow
      Dim oRowDetalle As DataRow
      Dim oRowCompra As DataRow
      Dim oRowCompraDet As DataRow
      Dim lngPosProv, lngPosCred As Long
      Try
         Call moDataSetInit()
      ...
      Try
         With oProveedor
            ...
            If .FindByPK Then
               oRow("TipoId") = 1
               oRow("CreditoId") = -1
               oRow("CreditoEsp") = "Proveedor " & .ProveedorCod
   ...
   Private Function GetCompra(ByVal oDataRow As DataRow) As DataRow
      ...
      oRow("TipoId") = 3
      oRow("CreditoId") = oDataRow("CompraId")
      oRow("CreditoEsp") = "        Compra " & oDataRow("CompraNro")
      oRow("Fecha") = ToDateDMY(oDataRow("Fecha"))
      oRow("CreditoDes") = oDataRow("CompraDes")
      oRow("CompraOrden") = oDataRow("CompraOrden")

      If oDataRow("MonedaId") = mlngMonedaId Then
         oRow("Capital") = oDataRow("MontoLiq")
         oRow("CapitalAmo") = oDataRow("MontoAnt")

      ElseIf oDataRow("MonedaId") = 1 Then
         oRow("Capital") = oDataRow("MontoLiq") / ToDivByCero(oDataRow("TipoCambio"))
         oRow("CapitalAmo") = oDataRow("MontoAnt") / ToDivByCero(oDataRow("TipoCambio"))

      ElseIf oDataRow("MonedaId") = 2 Then
         oRow("Capital") = oDataRow("MontoLiq") * oDataRow("TipoCambio")
         oRow("CapitalAmo") = oDataRow("MontoAnt") * oDataRow("TipoCambio")

      End If

      oRow("CapitalDif") = ToDecimal(oRow("Capital") + oRow("CapitalAmo"))
   ...
   Private Function GetCompraDet(ByVal oDataRow As DataRow, ByVal lngMonedaId As Long, ByVal decTipoCambio As Decimal) As DataRow
      ...
      oRow("CreditoId") = 0
      oRow("CreditoEsp") = "            Item"
      oRow("CreditoDes") = oDataRow("ItemDes")
      oRow("Fecha") = oDataRow("MedidaDes")
      oRow("Capital") = oDataRow("Cantidad")

      If lngMonedaId = mlngMonedaId Then
         oRow("CapitalDif") = ToDecimal(oDataRow("ImporteBru"))

      ElseIf lngMonedaId = 1 Then
         oRow("CapitalDif") = ToDecimal(ToDouble(oDataRow("ImporteBru")) / ToDivByCero(decTipoCambio))
      ...
      oRow("CapitalAmo") = ToDecimal(oRow("CapitalDif") / oDataRow("Cantidad"))
   ...
   Private Function TieneMovimiento(ByVal lngProveedorId As Long) As Boolean
      ...
      Try
         With moCreditoDet
            ...
            If mboolIntervaloFecha Then
               .WhereFilter = clsCreditoDet.WhereFilters.TieneMovimientoFecha
               .Fecha = mstrFechaIni
               .FechaAmo = mstrFechaFin
            Else
               .WhereFilter = clsCreditoDet.WhereFilters.TieneMovimiento
            End If
   ...
   Private Sub frmCompraEditLoad()
      ...
      Try
         If ToLong(grdMain.GetValue("CreditoId")) > 0 Then
            With oCompra
               .CompraId = ToLong(grdMain.GetValue("CreditoId"))
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("CapitalDif").Width = 80
   ...
   Private Sub AddConditionalFormatting()
      ...
      fc = New Janus.Windows.GridEX.GridEXFormatCondition(grdMain.RootTable.Columns("TipoId"), Janus.Windows.GridEX.ConditionOperator.Equal, 1)
      fc.FormatStyle.ForeColor = Color.DarkRed
      grdMain.RootTable.FormatConditions.Add(fc)

      fc = New Janus.Windows.GridEX.GridEXFormatCondition(grdMain.RootTable.Columns("TipoId"), Janus.Windows.GridEX.ConditionOperator.Equal, 2)
      fc.FormatStyle.ForeColor = Color.DarkBlue
      grdMain.RootTable.FormatConditions.Add(fc)

      fc = New Janus.Windows.GridEX.GridEXFormatCondition(grdMain.RootTable.Columns("TipoId"), Janus.Windows.GridEX.ConditionOperator.Equal, 3)
   ...
   Private Sub frmCreditoDet_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCreditoDet_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
