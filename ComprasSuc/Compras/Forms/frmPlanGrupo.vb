...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmPlanGrupo))
...
#End Region
   ...
   Private Sub frmPlanGrupo_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmPlanGrupo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moPlanGrupo
            .SelectFilter = clsPlanGrupo.SelectFilters.Grid
            .WhereFilter = clsPlanGrupo.WhereFilters.Grid
            .OrderByFilter = clsPlanGrupo.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("PlanGrupoId")) > 0) Then
            With oPlanGrupo
               .PlanGrupoId = ToLong(grdMain.GetValue("PlanGrupoId"))
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oPlanGrupo.EmpresaId = mlngEmpresaId
   ...
   Private Sub DataDelete()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If Not ItemFind(ToLong(grdMain.GetValue("PlanGrupoId"))) Then
               If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                  With oPlanGrupo
                     .WhereFilter = clsPlanGrupo.WhereFilters.PrimaryKey
                     .PlanGrupoId = ToLong(grdMain.GetValue("PlanGrupoId"))
               ...
               End If
            Else
               MessageBox.Show("Imposible Eliminar El Registro, Debido a que ya Tiene Uno o Mas Items", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
         Else
            MessageBox.Show("Debe Seleccionar un Registro", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
         End If
   ...
   Private Function ItemFind(ByVal lngPlanGrupoId As Long) As Boolean
      Dim oItem As New clsItem(clsAppInfo.ConnectString)

      Try
         With oItem
            .SelectFilter = clsItem.SelectFilters.ListBox
            .WhereFilter = clsItem.WhereFilters.PlanGrupoId
            .EmpresaId = mlngEmpresaId
   ...
   Private Sub PrintReport()
      Dim rpt As New rptPlanGrupo

      rpt.DataSource = GetDataView(moPlanGrupo.DataSet.Tables(moPlanGrupo.TableName))

      rpt.lblTitle.Text = "Grupos de Cuentas"
      rpt.Document.Name = "Grupos de Cuentas"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("PlanGrupoId")
   ...
   Private Sub FormInit()
      ...
      moPlanGrupo = New clsPlanGrupo(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Grupos de Cuentas"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("PlanGrupoDes").Caption = "Descripción"
         .RootTable.Columns("PlanGrupoDes").Width = 150
         ...
         .RootTable.Columns("PlanDesAct").Width = 150
         ...
         .RootTable.Columns("PlanIdTra").Visible = False

         .RootTable.Columns("PlanDesTra").Caption = "Cuenta Transito"
         .RootTable.Columns("PlanDesTra").Width = 150
         .RootTable.Columns("PlanDesTra").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("PlanDesTra").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("PlanIdIng").Visible = False

         .RootTable.Columns("PlanDesIng").Caption = "Cuenta Ingreso"
         .RootTable.Columns("PlanDesIng").Width = 150
         .RootTable.Columns("PlanDesIng").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("PlanDesIng").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("PlanIdCos").Visible = False

         .RootTable.Columns("PlanDesCos").Caption = "Cuenta Costo"
         .RootTable.Columns("PlanDesCos").Width = 150
         .RootTable.Columns("PlanDesCos").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("PlanDesCos").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
      End With
   End Sub
   ...
   Private Sub frmPlanGrupo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmPlanGrupo_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moPlanGrupo.Dispose()
      Call ClearMemory()
   End Sub
