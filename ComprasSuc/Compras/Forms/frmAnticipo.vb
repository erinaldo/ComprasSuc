...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.Text = "Anticipos y Devoluciones de Anticipos"
...
#End Region
   ...
   Private Sub frmAnticipo_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
   ...
   Private Sub grdMainLoad()
      Try
         With moAnticipo
            .SelectFilter = clsAnticipo.SelectFilters.Grid
            .WhereFilter = clsAnticipo.WhereFilters.Grid
            .OrderByFilter = clsAnticipo.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("AnticipoId")) > 0) Then
            With oAnticipo
               .AnticipoId = ToLong(grdMain.GetValue("AnticipoId"))
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oAnticipo.EmpresaId = mlngEmpresaId
            oAnticipo.GestionId = clsAppInfo.GestionId
            oAnticipo.AppId = clsAppInfo.AppId
            oAnticipo.Fecha = FechaServidor()
            oAnticipo.MonedaId = ToLong(clsAppInfo.MonedaId)

            .DataObject = oAnticipo
            .ShowDialog()
   ...
   Private Sub DataEdit()
      ...
      Try
         If grdMain.RowCount > 0 Then
            If ToLong(grdMain.GetValue("AnticipoId")) > 0 Then
               ''If ToLong(grdMain.GetValue("EstadoId")) = 13 Then
               If (ToLong(grdMain.GetValue("EstadoId")) = clsEstado.PENDIENTE) _
                  Or ((ToLong(grdMain.GetValue("EstadoId")) = clsEstado.REALIZADO) _
                  And (ToLong(grdMain.GetValue("TipoAnticipoId")) = clsTipoAnticipo.DEVOLUCION_ANTICIPO)) Then
                  ...
                  End With
               Else
                  MessageBox.Show("Imposible Editar El Documento", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               End If
            Else
         ...
         If grdMain.RowCount > 0 Then
            If ToLong(grdMain.GetValue("AnticipoId")) > 0 Then
               If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                  With oAnticipo
                     .WhereFilter = clsAnticipo.WhereFilters.PrimaryKey
                     .AnticipoId = ToLong(grdMain.GetValue("AnticipoId"))
   ...
   Private Sub PrintReport()
      Dim rpt As New rptAnticipo

      rpt.DataSource = GetDataView(moAnticipo.DataSet.Tables(moAnticipo.TableName))

      rpt.lblTitle.Text = "Anticipos y Devoluciones de Anticipos"
      rpt.Document.Name = "Anticipos y Devoluciones de Anticipos"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("AnticipoId")
   ...
   Private Sub FormInit()
      ...
      txtMaxReg.Text = ToStr(CompraParaRowsMaxFind(clsAppInfo.EmpresaId, clsAppInfo.GestionId, 4, clsAppInfo.SucursalId))
   End Sub
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("AnticipoOrden").Caption = "Nro. Orden"
         .RootTable.Columns("AnticipoOrden").Width = 100
         .RootTable.Columns("AnticipoOrden").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("AnticipoOrden").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
   ...
   Private Sub frmAnticipo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmAnticipo_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moAnticipo.Dispose()
      Call ClearMemory()
   End Sub
