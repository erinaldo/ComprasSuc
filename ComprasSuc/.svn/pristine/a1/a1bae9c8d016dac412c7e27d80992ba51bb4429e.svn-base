...
#End Region
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("Telefono1").Caption = "Telefono 1"
         ...
         .RootTable.Columns("Telefono2").Caption = "Telefono 2"
         ...
         .RootTable.Columns("Movil").Caption = "Movil"
         ...
         .RootTable.Columns("MonedaDes").Caption = "Mes Cierre"
         ...
         .RootTable.Columns("EstadoDes").Caption = "Mes Cierre"
