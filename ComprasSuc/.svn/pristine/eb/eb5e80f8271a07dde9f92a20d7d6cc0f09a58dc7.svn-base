Public Class frmCompraDescuentoEdit
   ...
   WriteOnly Property DataObject() As clsCompraDescuento
      Set(ByVal Value As clsCompraDescuento)
         moCompraDescuento = Value
      End Set
   End Property
...
#Region " Windows Form Designer generated code "
   ...
   Friend WithEvents txtCompraDescuentoId As Janus.Windows.GridEX.EditControls.EditBox
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCompraDescuentoEdit))
      ...
      Me.txtCompraDescuentoId = New Janus.Windows.GridEX.EditControls.EditBox
      ...
      Me.grpMain.Controls.Add(Me.cboPlanDescuento)
      Me.grpMain.Controls.Add(Me.Label1)
      Me.grpMain.Controls.Add(Me.txtCompraDescuentoId)
      ...
      Me.chkAplicarCosto.Location = New System.Drawing.Point(312, 92)
      ...
      Me.cboPlanDescuento.Location = New System.Drawing.Point(116, 40)
      ...
      Me.cboPlanDescuento.Size = New System.Drawing.Size(320, 20)
      Me.cboPlanDescuento.TabIndex = 1
      ...
      '
      'txtCompraDescuentoId
      '
      Me.txtCompraDescuentoId.ForeColor = System.Drawing.SystemColors.HotTrack
      Me.txtCompraDescuentoId.Location = New System.Drawing.Point(116, 16)
      Me.txtCompraDescuentoId.Name = "txtCompraDescuentoId"
      Me.txtCompraDescuentoId.ReadOnly = True
      Me.txtCompraDescuentoId.Size = New System.Drawing.Size(124, 20)
      Me.txtCompraDescuentoId.TabIndex = 0
      Me.txtCompraDescuentoId.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
      Me.txtCompraDescuentoId.VisualStyle = Janus.Windows.GridEX.VisualStyle.Office2007
      '
      'Label4
      '
      ...
      Me.Name = "frmCompraDescuentoEdit"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "CompraDescuento Edit"
...
#End Region
   ...
   Private Sub cdmMain_CommandClick(ByVal sender As System.Object, ByVal e As Janus.Windows.UI.CommandBars.CommandEventArgs) Handles cdmMain.CommandClick
      ...
      Select Case e.Command.Key
         Case "Save"
            If DataSave() Then
               mlngID = moCompraDescuento.CompraDescuentoId
               mboolChanged = True
               Me.Close()
            End If
   ...
   Private Sub frmCompraDescuentoEdit_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCompraDescuentoEdit_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
      ...
      If Not mboolAdding Then
         ...
         If Not mboolEditing Then
            Call DataReadOnly()
            Me.Text = "Consulta Descuento"
         Else
            Me.Text = "Editar Descuento"
         End If
      Else
         Me.Text = "Nuevo Descuento"
         Call FormNew()
      End If
   ...
   Private Sub FormShow()
      ...
      With moCompraDescuento
         txtCompraDescuentoId.Text = ToStr(.CompraDescuentoId)
   ...
   Private Sub DataClear()
      mboolShow = True
      With moCompraDescuento
         txtCompraDescuentoId.Text = String.Empty
   ...
   Private Sub DataReadOnly()
      txtCompraDescuentoId.ReadOnly = True
   ...
   Private Sub DataMove()
      With moCompraDescuento
         If Not mboolAdding Then
            .CompraDescuentoId = ToLong(txtCompraDescuentoId.Text)
         End If
   ...
   Private Function DataAdd() As Boolean
      Try
         ...
         If moCompraDescuento.Insert() Then
            mboolAdding = False
            DataAdd = True
         End If
   ...
   Private Function DataUpdate() As Boolean
      Try
         ...
         If moCompraDescuento.Update() Then
            DataUpdate = True
         End If
   ...
   Private Sub cboPlanDescuentoLoad()
      ...
      Try
         With oPlanDescuento
            ...
            .EmpresaId = moCompraDescuento.EmpresaId
   ...
   Private Sub frmCompraDescuentoEdit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCompraDescuentoEdit_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
