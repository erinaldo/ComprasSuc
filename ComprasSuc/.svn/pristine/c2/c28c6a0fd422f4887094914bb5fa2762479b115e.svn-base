...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCreditoPago))
      ...
      Me.UiCommandBar1.Commands.AddRange(New Janus.Windows.UI.CommandBars.UICommand() {Me.New1, Me.Separator3, Me.Refrescar1, Me.Separator1, Me.ViewAll1, Me.Separator4, Me.Print1, Me.Separator5, Me.Exit1})
      Me.UiCommandBar1.Key = "tbrMain"
      Me.UiCommandBar1.Location = New System.Drawing.Point(0, 0)
      Me.UiCommandBar1.Name = "UiCommandBar1"
      Me.UiCommandBar1.RowIndex = 0
      Me.UiCommandBar1.Size = New System.Drawing.Size(427, 28)
      Me.UiCommandBar1.Text = "tbrMain"
      '
      'New1
      '
      Me.New1.ImageIndex = 0
      Me.New1.Key = "New"
      Me.New1.Name = "New1"
      Me.New1.Text = "Nuevo Pago"
      '
      'Separator3
      '
      ...
      'mnuMain
      '
      Me.mnuMain.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuShow, Me.mnuNew})
      '
      'mnuShow
      '
      Me.mnuShow.Index = 0
...
#End Region
   ...
   Private Sub frmCreditoPago_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmCreditoPago_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moProveedor
            .SelectFilter = clsProveedor.SelectFilters.GridPagoCredito
            .WhereFilter = clsProveedor.WhereFilters.GridPagoCredito
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("EmpresaId")) > 0) Then
            With oCreditoDet
               ...
               Dim frm As New frmCreditoPagoEdit
      ...
      Try
         If grdMain.RowCount > 0 Then
            With frm
               ...
               oCreditoDet.EmpresaId = ToLong(grdMain.GetValue("EmpresaId"))
               oCreditoDet.ProveedorId = ToLong(grdMain.GetValue("ProveedorId"))
   ...
   Private Sub PrintReport()
      ...
      rpt.lblTitle.Text = "Proveedores con Notas al Crédito"
      rpt.Document.Name = "Proveedores con Notas al Crédito"
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Pago de Notas al Crédito"
         .ContextMenu = mnuMain
   ...
   Private Sub frmCreditoPago_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmCreditoPago_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moProveedor.Dispose()
      Call ClearMemory()
   End Sub
