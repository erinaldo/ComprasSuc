...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.Text = "Parámetros de Documentos"
...
#End Region
         ...
         If (clsAppInfo.SucursalId > 0) Then
            ...
            Else ''Por sucursales   
               ...
               If SucursalApeParaExist(clsAppInfo.EmpresaId, clsAppInfo.GestionId, strSucursalName) Then
                  ...
                  If MessageBox.Show("¿Realmente Quiere Aperturar los Parámetros?" & vbCrLf & strSucursalName, Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                     If CompraParaSucuAdd(clsAppInfo.EmpresaId, clsAppInfo.GestionId, strSucursalName) Then
                        Call grdMainLoad()
                        'MessageBox.Show("Parámetros Aperturados para las Sucursales : " & vbCrLf & strSucursalName, Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
               ...
               If .Insert() Then
                  ...
                  If .Insert() Then
                     ...
                     Else
                        ...
                        .NroActual = 0
                        .ConFac = 0
                        .Titulo = "Devolución Sobre Compra"
                        .Firma = "_________________________                    _________________________                    _________________________" & vbCrLf & "Vo Bo                                                            Contador                                                        Interesado"
                        .TipoHojaId = 2 'Media Carta
                        .RowsMax = 0
                        .PrintAuto = False
                     ...
                     If .Insert() Then
                        ...
                        If .Insert() Then
                           ...
                           Else
                              ...
                              .NroActual = 0
                              .ConFac = 0
                              .Titulo = "Devolución Anticipo a Proveedor"
                              .Firma = "_________________________                    _________________________                    _________________________" & vbCrLf & "Vo Bo                                                            Contador                                                        Interesado"
                              .TipoHojaId = 2 'Media Carta
                              .RowsMax = 0
                              .PrintAuto = False
                           ...
                           If .Insert() Then
                              ...
                              Else
                                 ...
                                 .NroActual = 0
                                 .ConFac = 0
                                 .Titulo = "Programación Credito de Proveedor"
                                 .Firma = "_________________________                    _________________________                    _________________________" & vbCrLf & "Vo Bo                                                            Contador                                                        Interesado"
                                 .TipoHojaId = 2 'Media Carta
                                 .RowsMax = 0
                                 .PrintAuto = False
   ...
   Private Sub PrintReport()
      ...
      'rpt.lblTitle.Text = "Parámetros de Notas"
      'rpt.Document.Name = "Parámetros de Notas"
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Parámetros de Documentos"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("Titulo").Caption = "Título"
