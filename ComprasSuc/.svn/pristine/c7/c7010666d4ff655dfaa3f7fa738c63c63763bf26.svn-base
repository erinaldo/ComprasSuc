Public Class frmItemProveedorMov
   ...
   Private mboolPorProveedor As Boolean

   Private mdecCantidad As Decimal
   Private mdecImporte As Decimal
   Private mdecCantidadResu As Decimal
   Private mdecImporteResu As Decimal
   ...
   Property PorProveedor() As Boolean
      Get
         Return mboolPorProveedor
      End Get

      Set(ByVal Value As Boolean)
         mboolPorProveedor = Value
      End Set
   End Property
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmItemProveedorMov))
      ...
      Me.KeyPreview = True
      Me.Name = "frmItemProveedorMov"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Ítems Vendidos a un Proveedor"
...
#End Region
   ...
   Private Sub frmItemProveedorMov_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmItemProveedorMov_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
         ...
         With moCompraDet
            For Each lngProveedorId In moLista
               ...
               For Each lngItemId In moListaItem
                  .SelectFilter = clsCompraDet.SelectFilters.ItemProveedorMov

                  If mboolIntervaloFecha Then
                     .WhereFilter = clsCompraDet.WhereFilters.ItemProveedorMovFecha
                     .Fecha = mstrFechaIni
                     .LastUpdateDate = mstrFechaFin
                  Else
                     .WhereFilter = clsCompraDet.WhereFilters.ItemProveedorMov
                  End If
                  ...
                  If .Open() Then
                     ...
                     For Each oRow In .DataSet.Tables(.TableName).Rows
                        ...
                        If mboolDetallado And Not mboolPorProveedor Then
                  ...
                  If Not mboolDetallado And Not mboolPorProveedor Then
               ...
               If boolHeader Then
                  If Not mboolPorProveedor Then
                     moDataTable.Rows.Add(GetRowFooter(strMonedaDes))
                     moDataTable.Rows.Add(GetRowNull)
                  Else
                     RowFooterResumidoExtendido(moDataTable.Rows(lngPos - 1), strMonedaDes)
                  End If
               End If
            Next
   ...
   Private Function GetRow(ByVal oDataRow As DataRow) As DataRow
      ...
      If Not mboolDetallado Then
         mdecCantidadResu += ToDecimal(oRow("Cantidad"))
         mdecImporteResu += ToDecimal(oRow("Importe"))
      End If
   ...
   Private Function GetHeader(ByVal lngProveedorId As Long) As DataRow
      ...
      Try
         oRow("CompraId") = -1
         oRow("CompraNro") = "Proveedor"

         With oProveedor
            .ProveedorId = lngProveedorId

            If .FindByPK Then
               oRow("ItemCod") = .ProveedorCod
               oRow("ItemDes") = .ProveedorDes
            End If
         End With
   ...
   Private Sub RowFooterResumidoExtendido(ByRef oDataRow As DataRow, ByVal strMonedaDes As String)

      oDataRow("CompraId") = -1
      oDataRow("Cantidad") = mdecCantidad
      oDataRow("Importe") = mdecImporte
   ...
   Private Sub PrintReport()
      If Not mboolPorProveedor Then
         ...
         rpt.lblTitle.Text = "Ítems Vendidos a un Proveedor"
         rpt.Document.Name = "Ítems Vendidos a un Proveedor"
      ...
      Else
         ...
         Dim rpt As New rptItemProveedorMovPorProveedor
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Ítems Vendidos a un Proveedor"
         ...
         If mboolPorProveedor Then ' Solo los datos del Proveedor
            .RootTable.Columns("Fecha").Visible = False
   ...
   Private Sub frmItemProveedorMov_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmItemProveedorMov_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
      moCompraDet.Dispose()
      Call ClearMemory()
   End Sub
