Public Class frmProveedorMovExt
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmProveedorMovExt))
...
#End Region
   ...
   Private Sub frmProveedorMovExt_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmProveedorMovExt_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub GetMovimiento(ByVal lngProveedorId As Long)
      ...
      With moProveedorMov
         ...
         If .Open() Then
            ...
            If mboolIntervaloFecha Then
               mdecSaldo = ProveedorSaldoAnterior(.ProveedorId)
            Else
               mdecSaldo = 0
            End If
   ...
   Private Function GetRow(ByVal oDataRow As DataRow) As DataRow
      ...
      ElseIf oRow("TipoCompraId") = 6 Then 'Credito
         oRow("ProveedorMovDes") = CompraOrdenFind(oRow("DocumentoId"))

      ElseIf oRow("TipoCompraId") = 7 Then 'Pago
         Dim decMontoRec As Decimal

         oRow("MontoDes") = PagoMontoDesFind(oRow("DocumentoId"), mlngMonedaId, decMontoRec)
         ...
         If oDataRow("TipoPagoId") = 1 Then
            oRow("TipoCompraDes") = "Pago Contado"
         Else
   ...
   Private Function PagoMontoDesFind(ByVal lngPagoId As Long, ByVal lngMonedaId As Long, ByRef decMontoRec As Decimal) As Decimal
   ...
   Private Function ProveedorSaldoActual(ByVal lngProveedorId As Long) As Decimal
      Dim oProveedorMov As New clsProveedorMov(clsAppInfo.ConnectString)
      Dim decDebe As Decimal = 0
      Dim decHaber As Decimal = 0
   ...
   Private Sub PrintReport()
      Dim rpt As New rptProveedorMovExt
   ...
   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Movimiento de Proveedores Extendido"
   ...
   Private Sub frmProveedorMovExt_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmProveedorMovExt_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
