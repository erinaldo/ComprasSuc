...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.grdMain.BuiltInTextsData = "<LocalizableData ID=""LocalizableStrings"" Collection=""true""><FilterRowConditionEqu" & _
          "al>Igual</FilterRowConditionEqual></LocalizableData>"
