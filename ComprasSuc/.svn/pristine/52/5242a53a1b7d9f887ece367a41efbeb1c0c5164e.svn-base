...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmCreditoIni))
...
#End Region
   ...
   Private Sub grdMainLoad()
      Try
         With moCredito
            .SelectFilter = clsCredito.SelectFilters.GridIni
            .WhereFilter = clsCredito.WhereFilters.GridIni
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oCredito.FechaIni = ToStr(grdMain.GetValue("FechaIni"))
            oCredito.MonedaId = ToLong(grdMain.GetValue("MonedaId"))
            oCredito.TipoCambio = ToDecimal(grdMain.GetValue("TipoCambio"))
            oCredito.TipoCreditoId = ToLong(grdMain.GetValue("TipoCreditoId"))
            oCredito.InteresAnual = ToDecimal(grdMain.GetValue("InteresAnual"))
   ...
   Private Sub PrintReport()
      ...
      rpt.DataSource = moCredito.DataSet.Tables(moCredito.TableName).DefaultView

      rpt.lblTitle.Text = "Saldos Iniciales"
      rpt.Document.Name = "Saldos Iniciales"
   ...
   Private Sub FormInit()
      ...
      txtMaxReg.Text = ToStr(CompraParaRowsMaxFind(clsAppInfo.EmpresaId, clsAppInfo.GestionId, 8, clsAppInfo.SucursalId))
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Saldos Iniciales"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("TipoCreditoDes").Caption = "Tipo Crédito"
         ...
         .RootTable.Columns("CantidadCuota").FormatString = DecimalMask()
         .RootTable.Columns("CantidadCuota").Width = 100
         .RootTable.Columns("CantidadCuota").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
