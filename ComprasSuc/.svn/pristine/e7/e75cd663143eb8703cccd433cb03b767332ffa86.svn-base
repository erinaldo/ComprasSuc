Public Class frmFacturaOtroCostoEdit
   ...
   Private mdtFacturas As New DataTable
   Private mlngFacturaNroOld As Long
   Private mstrNroAutorzacionOld As String
   Private mlngCostoIdNro As Long
   ...
   Property dtFacturas() As DataTable
      Get
         Return mdtFacturas
      End Get
   ...
   Property CostoIdNro() As Long
      Get
         Return mlngCostoIdNro
      End Get

      Set(ByVal Value As Long)
         mlngCostoIdNro = Value
      End Set
   End Property
...
#Region " Windows Form Designer generated code "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmFacturaOtroCostoEdit))
      ...
      Me.bcgMain.Size = New System.Drawing.Size(462, 423)
      ...
      Me.UiGroupBox2.Location = New System.Drawing.Point(8, 356)
      ...
      Me.UiGroupBox1.Location = New System.Drawing.Point(8, 240)
      ...
      Me.Name = "frmFacturaOtroCostoEdit"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Factura Otro Costo"
...
#End Region
   ...
   Private Sub FormShow()
      ...
      With moFactura
         ...
         mlngFacturaNroOld = .FacturaNro
         mstrNroAutorzacionOld = .NroAutorizacion
   ...
   Private Function FormCheck() As Boolean
      ...
      Else 'Compra
         ...
         If FacturaNroDuplicado(moFactura.FacturaNro, moFactura.NroAutorizacion) Then
            strMsg &= "Nro de Factura Duplicado" & vbCrLf
         End If
      End If
   ...
   '         .WhereFilter = clsDosifica.WhereFilters.EstadoId
...
#End Region
   ...
   Private Function FacturaNroDuplicado(ByVal lngFacturaNro As Long, ByVal strNroAutorzacion As String) As Boolean
      Dim oRow As DataRow
      Dim lngIdFactura As Long
      FacturaNroDuplicado = False

      If mboolAdding Then
         If FacturaNroDuplicadoFind(lngFacturaNro, strNroAutorzacion) > 0 Then
            Return True
         End If

         For Each oRow In mdtFacturas.Rows
            If (oRow("FacturaNro") = lngFacturaNro) And (ToStr(oRow("NroAutorizacion")) = strNroAutorzacion) Then
               Return True
            End If
         Next

      ElseIf mboolEditing Then
         If (mlngFacturaNroOld <> lngFacturaNro) Or (mstrNroAutorzacionOld <> strNroAutorzacion) Then

            lngIdFactura = FacturaNroDuplicadoFind(lngFacturaNro, strNroAutorzacion)
            If lngIdFactura > 0 Then
               If moFactura.FacturaId <> lngIdFactura Then
                  Return True
               End If
            End If
   ...
   Private Function FacturaNroDuplicadoFind(ByVal lngFacturaNro As Long, ByVal strNroAutorzacion As String) As Long
      Dim oFactura As New clsFactura(clsAppInfo.ConnectString)

      FacturaNroDuplicadoFind = -1
      ...
      Try
         With oFactura
            ...
            If .Find Then
               FacturaNroDuplicadoFind = .FacturaId
            End If
         End With
