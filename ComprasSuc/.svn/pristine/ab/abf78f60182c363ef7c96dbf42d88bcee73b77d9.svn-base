...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmPlanOtroCosto))
      ...
      Me.KeyPreview = True
      Me.Name = "frmPlanOtroCosto"
      Me.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen
      Me.Text = "Otros Costos Aplicables"
...
#End Region
   ...
   Private Sub frmPlanOtroCosto_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmPlanOtroCosto_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moPlanOtroCosto
            .SelectFilter = clsPlanOtroCosto.SelectFilters.Grid
            .WhereFilter = clsPlanOtroCosto.WhereFilters.Grid
            .OrderByFilter = clsPlanOtroCosto.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("PlanOtroCostoId")) > 0) Then
            With oPlanOtroCosto
               .PlanOtroCostoId = ToLong(grdMain.GetValue("PlanOtroCostoId"))
   ...
   Private Sub FormNew()
      ...
      Try
         With frm
            ...
            oPlanOtroCosto.EmpresaId = mlngEmpresaId
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oPlanOtroCosto
                  .WhereFilter = clsPlanOtroCosto.WhereFilters.PrimaryKey
                  .PlanOtroCostoId = ToLong(grdMain.GetValue("PlanOtroCostoId"))
   ...
   Private Sub PrintReport()
      ...
      rpt.DataSource = GetDataView(moPlanOtroCosto.DataSet.Tables(moPlanOtroCosto.TableName))

      rpt.lblTitle.Text = "Otros Costos Aplicables"
      rpt.Document.Name = "Otros Costos Aplicables"
      rpt.lblPlanDescuentoDes.Text = "Descripción Otro Costo"
      rpt.txtPlanDescuentoDes.DataField = "PlanOtroCostoDes"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("PlanOtroCostoId")
   ...
   Private Sub FormInit()
      ...
      moPlanOtroCosto = New clsPlanOtroCosto(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Otros Costos Aplicables"
         .ContextMenu = mnuMain
         ...
         .RootTable.Columns("PlanOtroCostoDes").Caption = "Descripción Otro Costo"
         .RootTable.Columns("PlanOtroCostoDes").Width = 200
         ...
         .RootTable.Columns("PlanDes").Caption = "Cuenta Otro Costo"
   ...
   Private Sub frmPlanOtroCosto_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmPlanOtroCosto_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
