...
#Region " ActiveReports Designer generated code "
   ...
   Private txtAduanaNIT As DataDynamics.ActiveReports.TextBox = Nothing
   Private txtAduanaDes As DataDynamics.ActiveReports.TextBox = Nothing
   Private txtDireccion As DataDynamics.ActiveReports.TextBox = Nothing
   Private txtTelefono As DataDynamics.ActiveReports.TextBox = Nothing
