Public Class frmProveedorMov
   ...
   Private mboolExtendido As Boolean
...
#Region " Set and Get "
   ...
   Property Extendido() As Boolean
      Get
         Return mboolExtendido
      End Get

      Set(ByVal Value As Boolean)
         mboolExtendido = Value
      End Set
   End Property
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmProveedorMov))
...
#End Region
   ...
   Private Sub frmProveedorMov_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmProveedorMov_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub FormInit()
      ...
      If mboolResumido Then
         ...
         cdmMain.Commands.Item("Book").IsVisible = False
         cdmMain.Commands.Item("Book").Enabled = False
      ElseIf mboolExtendido Then
         Me.Text = "Movimiento de Proveedores Extendido"
      Else
         Me.Text = "Movimiento de Proveedores"
      End If
   ...
   Private Sub DocumentoEditLoad()
      If grdMain.RowCount > 0 And ToLong(grdMain.GetValue("ProveedorMovId")) <> 0 _
     And ToLong(grdMain.GetValue("TipoCompraId")) > 0 Then
         ...
         ElseIf ToLong(grdMain.GetValue("TipoCompraId")) = 8 Then 'Saldo Inicial
            Call frmCreditoIniEditLoad(ToLong(grdMain.GetValue("DocumentoId")), ToLong(grdMain.GetValue("ProveedorMovId")))
...
#Region " Documentos "
   ...
   Private Sub frmCreditoIniEditLoad(ByVal lngCreditoId As Long, ByVal lngProveedorMovId As Long)
      If lngCreditoId > 0 Then
         Dim oCredito As New clsCredito(clsAppInfo.ConnectString)
         Try
            With oCredito
...
#End Region
   ...
   Private Sub PrintReport()
      ...
      If mboolResumido Then
         rpt = New rptProveedorMovResu
      ElseIf mboolExtendido Then
         rpt = New rptProveedorMovExt
      Else
         rpt = New rptProveedorMov
      End If
   ...
   Private Sub frmProveedorMov_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmProveedorMov_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
...
#Region " DataSet "
   Private Sub moDataSetInit()
      ...
      moDataTable.Columns.Add("DocumentoOrden", Type.GetType("System.String"))
   ...
   Private Function GetProveedor(ByVal oDataRow As DataRow) As DataRow
      Dim oRow As DataRow
      oRow = moDataTable.NewRow

      oRow("Id") = 1
      oRow("ProveedorMovId") = -1
      oRow("ProveedorId") = oDataRow("ProveedorId") '.ProveedorCod
      oRow("TipoCompraDes") = "Proveedor"
      oRow("DocumentoNro") = oDataRow("ProveedorCod") '.ProveedorCod
      oRow("ProveedorMovDes") = oDataRow("ProveedorDes") ' .ProveedorDes
      oRow("Saldo") = ProveedorSaldoAnterior(oDataRow("ProveedorId"))
      If mboolResumido Then
         oRow("TipoCambio") = oRow("Saldo")
         oRow("Debe") = 0
         oRow("Haber") = 0
         oRow("Saldo") = 0
      End If
   ...
   Private Function GetRow(ByVal oDataRow As DataRow) As DataRow
      ...
      Dim strDocumentoOrden As String
      Dim decMontoDes, decMontoRec As Decimal
      ...
      If oRow("TipoCompraId") = 2 Then 'Compra
         ...
         oRow("DocumentoNro") = CompraNroFind(oRow("DocumentoId"), strDocumentoOrden)
         oRow("DocumentoOrden") = strDocumentoOrden
      ...
      ElseIf oRow("TipoCompraId") = 3 Then 'Devolución Compra
         ...
         oRow("DocumentoOrden") = String.Empty
         oRow("ProveedorMovDes") = oDataRow("ProveedorMovDes")
      ...
      ElseIf oRow("TipoCompraId") = 6 Then 'Credito
         ...
         strDocumentoOrden = CompraOrdenFind(oRow("DocumentoId"))
         oRow("DocumentoOrden") = strDocumentoOrden
         If ToStr(oDataRow("ProveedorMovDes")) <> String.Empty Then
            oRow("ProveedorMovDes") = oDataRow("ProveedorMovDes")
         ElseIf strDocumentoOrden <> String.Empty Then
            oRow("ProveedorMovDes") &= "Nro. Orden " & strDocumentoOrden
         End If

      ElseIf oRow("TipoCompraId") = 7 Then 'Pago
         oRow("DocumentoNro") = PagoNroFind(oRow("DocumentoId"), decMontoRec, decMontoDes)
         oRow("DocumentoOrden") = PagoCompraOrdenFind(oRow("DocumentoId"))
         oRow("ProveedorMovDes") = oDataRow("ProveedorMovDes")
         ...
         End If
         If decMontoDes = 0 Then
            oRow("MontoDes") = System.Convert.DBNull
         Else
            oRow("MontoDes") = decMontoDes
         End If
         If decMontoRec = 0 Then
            oRow("MontoRec") = System.Convert.DBNull
         Else
            oRow("MontoRec") = decMontoRec
         End If
      ElseIf oRow("TipoCompraId") = 8 Then 'Saldo Inicial
         oRow("DocumentoNro") = CreditoNroFind(oRow("DocumentoId"), strDocumentoOrden)
         oRow("DocumentoOrden") = strDocumentoOrden
         oRow("ProveedorMovDes") = oDataRow("ProveedorMovDes")
      ...
      oRow("Saldo") = ToDecimalCinco(moDataTable.Compute("Sum(Haber)", "Id = 2 And ProveedorId = " & oDataRow("ProveedorId"))) + oRow("Haber") + ToDecimalCinco(moDataTable.Compute("Sum(Saldo)", "Id = 1 And ProveedorId = " & oDataRow("ProveedorId"))) - ToDecimalCinco(moDataTable.Compute("Sum(Debe)", "Id = 2 And ProveedorId = " & oDataRow("ProveedorId"))) - oRow("Debe")
   ...
   Private Sub RowEdit(ByVal oRow As DataRow, ByVal oDataRow As DataRow)
      If mlngMonedaId = 1 Then
         oRow("Debe") = oRow("Debe") + oDataRow("DebeBs")
         oRow("Haber") = oRow("Haber") + oDataRow("HaberBs")

      ElseIf mlngMonedaId = 2 Then
         oRow("Debe") = oRow("Debe") + oDataRow("DebeUs")
         oRow("Haber") = oRow("Haber") + oDataRow("HaberUs")
      End If

      oRow("Saldo") = oRow("Haber") + oRow("TipoCambio") - oRow("Debe")
   End Sub
   ...
   Private Function GetCompra(ByVal oDataRow As DataRow) As DataRow
      ...
      If ToStr(oDataRow("CompraOrden")) <> "" Then
         oRow("DocumentoOrden") = oDataRow("CompraOrden")
      ...
      ElseIf oDataRow("MonedaId") = 1 Then
         ...
         oRow("MontoDes") = oDataRow("MontoDes") / ToDivByCero(oDataRow("TipoCambio"))
         oRow("MontoRec") = oDataRow("MontoRec") / ToDivByCero(oDataRow("TipoCambio"))

      ElseIf oDataRow("MonedaId") = 2 Then
         oRow("Haber") = oDataRow("MontoLiq") * oDataRow("TipoCambio")
         oRow("MontoDes") = oDataRow("MontoDes") * oDataRow("TipoCambio")
         oRow("MontoRec") = oDataRow("MontoRec") * oDataRow("TipoCambio")
      End If

      If oRow("MontoDes") = 0 Then
         oRow("MontoDes") = System.Convert.DBNull
      End If
      If oRow("MontoRec") = 0 Then
         oRow("MontoRec") = System.Convert.DBNull
      End If
      Return oRow
   End Function

   Private Function GetCompraDet(ByVal oDataRow As DataRow, ByVal lngMonedaId As Long, ByVal decTipoCambio As Decimal, ByVal lngProveedorId As Long) As DataRow
      Dim oRow As DataRow
      oRow = moDataTable.NewRow

      oRow("Id") = 3
      oRow("ProveedorMovId") = -2
      oRow("TipoCompraDes") = "Ítem"
      oRow("DocumentoNro") = oDataRow("ItemCod")
      oRow("ProveedorId") = lngProveedorId
   ...
   Private Function GetRowNull(ByVal lngProveedorId As Long) As DataRow
      Dim oRow As DataRow
      oRow = moDataTable.NewRow
      oRow("ProveedorId") = lngProveedorId
      Return oRow
   ...
   Private Function GetFooter(ByVal lngProveedorId As Long) As DataRow
      Dim oRow As DataRow
      oRow = moDataTable.NewRow

      oRow("Id") = 4
      oRow("ProveedorMovId") = -1
      oRow("TipoCompraDes") = "Total " & MonedaDesFind(mlngMonedaId)
      oRow("Debe") = ToDecimal(moDataTable.Compute("Sum(Debe)", "Id = 2 And ProveedorId = " & lngProveedorId))
      oRow("Haber") = ToDecimal(moDataTable.Compute("Sum(Haber)", "Id = 2 And ProveedorId = " & lngProveedorId))
      oRow("Saldo") = ToDecimalCinco(moDataTable.Compute("Sum(Haber)", "Id = 2 And ProveedorId = " & lngProveedorId)) + ToDecimalCinco(moDataTable.Compute("Sum(Saldo)", "Id = 1 And ProveedorId = " & lngProveedorId)) - ToDecimalCinco(moDataTable.Compute("Sum(Debe)", "Id = 2 And ProveedorId = " & lngProveedorId)) ' ToDecimal(moDataTable.Compute("Sum(Saldo)", "ProveedorMovId > 0 and ProveedorId = " & lngProveedorId))
   ...
   Private Function GetFooterTotal() As DataRow
      ...
      If mboolResumido Then
         oRow("Debe") = ToDecimal(moDataTable.Compute("Sum(Debe)", "Id = 1"))
         oRow("Haber") = ToDecimal(moDataTable.Compute("Sum(Haber)", "Id = 1"))
         oRow("Saldo") = ToDecimal(moDataTable.Compute("Sum(Haber)", "Id = 1")) + ToDecimal(moDataTable.Compute("Sum(TipoCambio)", "ProveedorMovId = -1")) - ToDecimal(moDataTable.Compute("Sum(Debe)", "ProveedorMovId = -1"))
      Else
         oRow("Debe") = ToDecimal(moDataTable.Compute("Sum(Debe)", "Id = 4"))
         oRow("Haber") = ToDecimal(moDataTable.Compute("Sum(Haber)", "Id = 4"))
         oRow("Saldo") = ToDecimal(moDataTable.Compute("Sum(Saldo)", "Id = 4"))
      End If
...
#Region " Metodo "
   Private Function ProveedorSaldoAnterior(ByVal lngProveedorId As Long) As Decimal
            ...
            If .Open() Then
               Do While .Read()
                  For Each lngCentroCostoId As Integer In moListaCentroCosto
                     If .CentroCostoId = lngCentroCostoId Or lngCentroCostoId = -1 Then
   ...
   Private Function CreditoNroFind(ByVal lngCreditoId As Long, ByRef strCreditoOrden As String) As Long
      Dim oCredito As New clsCredito(clsAppInfo.ConnectString)
      ...
      Try
         With oCompra
            ...
            If .Open Then
               ...
               CompraOrdenFind = strCompraOrden
            End If
         End With
   ...
   Private Function PagoNroFind(ByVal lngPagoId As Long, Optional ByRef decMontoRec As Decimal = 0, Optional ByRef decMontoDes As Decimal = 0) As Long
      Dim oPago As New clsPago(clsAppInfo.ConnectString)
         ...
         With oPago
            ...
            If .FindByPK Then
               If .MonedaId = mlngMonedaId Then
                  decMontoRec = .MontoRec
                  decMontoDes = .MontoDes
               ElseIf .MonedaId = 1 Then
                  decMontoRec = ToDecimal(.MontoRec / .TipoCambio)
                  decMontoDes = ToDecimal(.MontoDes / .TipoCambio)
   ...
   Private Function PagoCompraOrdenFind(ByVal lngPagoId As Long) As String
      ...
      Dim strCompraOrden As String = String.Empty

      PagoCompraOrdenFind = String.Empty
      Try
         With oPagoDet
            ...
            If .Open Then
               For Each oRowPagoDet In .DataSet.Tables(.TableName).Rows
                  With oCompra
                     ...
                     If .Open Then
                        Do While .Read
                           If .CompraOrden <> String.Empty Then
                              strCompraOrden = .CompraOrden & " "
                           End If
   ...
   Private Sub AddRowsCompra(ByVal oRow As DataRow)
      Dim oCompra As New clsCompra(clsAppInfo.ConnectString)
                  ...
                  With oCompraDet
                     ...
                     If .Open() Then
                        For Each oRowCompraDet In .DataSet.Tables(.TableName).Rows
                           moDataTable.Rows.Add(GetCompraDet(oRowCompraDet, oRowCompra("MonedaId"), oRowCompra("TipoCambio"), oRowCompra("ProveedorId")))
                        Next
                     End If
                  End With
               Next

               moDataTable.Rows.Add(GetRowNull(oRow("ProveedorId")))
            End If
         End With
      End If
   ...
   Private Sub AddRowsCompraForPago(ByVal oRow As DataRow)
      Dim oPagoDet As New clsPagoDet(clsAppInfo.ConnectString)
      Dim oCompra As New clsCompra(clsAppInfo.ConnectString)
      Dim oCompraDet As New clsCompraDet(clsAppInfo.ConnectString)
   ...
   Private Sub DeleteRowsSaldoCero(ByVal lngProveedorId As Long)
      Dim lngIndex As Long = moDataTable.Rows.Count
      For indexB = lngIndex To 1 Step -1
         If ToLong(moDataTable.Rows(indexB - 1).Item("ProveedorId")) <> lngProveedorId Then
            Exit For
         End If

         If ToLong(moDataTable.Rows(indexB - 1).Item("ProveedorId")) = lngProveedorId Then
            moDataTable.Rows.Remove(moDataTable.Rows(indexB - 1))
         End If
      Next
   End Sub
#End Region
...
#Region " Grid "
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("DocumentoOrden").Caption = "Nro. Orden"
         .RootTable.Columns("DocumentoOrden").Width = 80
         .RootTable.Columns("DocumentoOrden").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("DocumentoOrden").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
         ...
         If mboolResumido Then
            ...
            .RootTable.Columns("TipoCompraDes").Visible = False
            .RootTable.Columns("DocumentoOrden").Visible = False
            .RootTable.Columns("DocumentoNro").Caption = "Código"
            .RootTable.Columns("DocumentoNro").Width = 100

            .RootTable.Columns("ProveedorMovDes").Width = 200

            .RootTable.Columns("TipoCambio").Caption = "Saldo Ant."
            .RootTable.Columns("TipoCambio").Width = 100

            .RootTable.Columns("TipoCompDes").Visible = False
            .RootTable.Columns("CompNro").Visible = False
         ElseIf mboolExtendido Then
            .RootTable.Columns("Fecha").Width = 80
            .RootTable.Columns("DocumentoNro").Visible = False
            .RootTable.Columns("DocumentoOrden").Visible = False
            .RootTable.Columns("TipoCambio").Caption = "T.C./Cant."
            .RootTable.Columns("Debe").Caption = "Debe/Precio"
            .RootTable.Columns("Haber").Caption = "Haber/Importe"
            .RootTable.Columns("TipoCompDes").Visible = False
            .RootTable.Columns("CompNro").Visible = False
            .RootTable.Columns("MontoDes").Visible = True
            .RootTable.Columns("MontoRec").Visible = True
         End If
      End With
   ...
   Private Sub grdMainLoad1()
      ...
      Try
         ...
         With moProveedorMov
            .SelectFilter = clsProveedorMov.SelectFilters.Kardex1
            .WhereFilter = clsProveedorMov.WhereFilters.KardexFecha1
            ...
            If .Open And .DataSet.Tables(.TableName).Rows.Count > 0 Then
               For Each lngProveedorId As Long In moListaProveedor
                  oDataRow = .DataSet.Tables(.TableName).Select("ProveedorId = " & lngProveedorId)
                  If oDataRow.Length > 0 Then
                     moDataTable.Rows.Add(GetProveedor(oDataRow(0)))
                     boolSw = False
                     For Each oRow In oDataRow
                        For Each lngCentroCostoId As Integer In moListaCentroCosto
                           If ToLong(oRow("CentroCostoId")) = lngCentroCostoId Or lngCentroCostoId = -1 Then
                              If (oRow("TipoCompraId") = 2 And mboolCompra) _
                                 Or (oRow("TipoCompraId") = 3 And mboolDevCompra) _
                                 Or (oRow("TipoCompraId") = 4 And mboolAnticipo) _
                                 Or (oRow("TipoCompraId") = 5 And mboolDevAnticipo) _
                                 Or (oRow("TipoCompraId") = 6 And mboolCredito) _
                                 Or (oRow("TipoCompraId") = 7 And mboolPago And oRow("TipoPagoId") = 2) _
                                 Or (oRow("TipoCompraId") = 7 And mboolPago And mboolCompra And oRow("TipoPagoId") = 1) _
                                 Or (oRow("TipoCompraId") = 8 And mboolSaldoIni) _
                                 Or (oRow("TipoCompraId") = 9 And mboolDesAnticipo) _
                                 Or (oRow("TipoCompraId") = 10 And mboolAjuste) Then
                                 boolSw = True
                                 If mboolResumido Then
                                 ...
                                 Else
                                    ...
                                    If (oRow("TipoCompraId") = 2 And mboolCompra And mboolDetalleCompra) _
                                    Or (oRow("TipoCompraId") = 6 And mboolCredito And mboolDetalleCompra) Then
                                       Call AddRowsCompra(oRow)
                                    ElseIf (oRow("TipoCompraId") = 7 And mboolPago And mboolCompra And oRow("TipoPagoId") = 1 And mboolDetalleCompra) Then
                                       Call AddRowsCompraForPago(oRow)
                                    End If
                                 End If
                              End If
                           End If
                     ...
                     Next
                     If boolSw Then
                        If ToDecimalCinco(moDataTable.Compute("Sum(Haber)", "Id = 2 And ProveedorId = " & lngProveedorId)) + ToDecimalCinco(moDataTable.Compute("Sum(Saldo)", "Id = 1 And ProveedorId = " & lngProveedorId)) - ToDecimalCinco(moDataTable.Compute("Sum(Debe)", "Id = 2 And ProveedorId = " & lngProveedorId)) = 0 And Not mboolSaldoCero Then
                           Call DeleteRowsSaldoCero(lngProveedorId)
                        ElseIf Not mboolResumido Then
                           moDataTable.Rows.Add(GetFooter(lngProveedorId))
