...
#End Region
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("PrimerMes").Caption = "1 - 30 DÍAS"
         ...
         .RootTable.Columns("SegundoMes").Caption = "31 - 60 DÍAS"
         ...
         .RootTable.Columns("TercerMes").Caption = "61 - 90 DÍAS"
         ...
         .RootTable.Columns("CuartoMes").Caption = "+91 DÍAS"
