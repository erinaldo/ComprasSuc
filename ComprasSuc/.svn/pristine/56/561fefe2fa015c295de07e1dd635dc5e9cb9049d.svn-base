...
#Region " ActiveReports Designer generated code "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(rptCreditoMov))
      ...
      Me.Detail.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.txtFecha, Me.txtCapital, Me.txtCapitalAmo, Me.txtCapitalDif, Me.txtCreditoEsp, Me.txtCreditoDes, Me.txtMora, Me.txtInteres, Me.txtCompraOrden, Me.txtCreditoId, Me.Line3})
      ...
      'PageHeader
      '
      Me.PageHeader.Controls.AddRange(New DataDynamics.ActiveReports.ARControl() {Me.Label6, Me.Label8, Me.Label, Me.Label7, Me.Label1, Me.Label4, Me.Label13, Me.Label2, Me.Label18})
...
#End Region
   ...
   Private Sub Detail_Format(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Detail.Format
      If ToLong(txtCreditoId.Text) = -1 Then
         txtCreditoDes.Style = "ddo-char-set: 1; font-weight: bold;  font-size: 8pt; "
         txtCreditoEsp.Style = "ddo-char-set: 1; font-weight: bold;  font-size: 8pt; "
         txtCompraOrden.Style = "ddo-char-set: 1; font-weight: bold;  font-size: 8pt; "
         txtFecha.Style = "ddo-char-set: 1; font-weight: bold;  font-size: 8pt; "
         txtMora.Style = "ddo-char-set: 1; text-align: center; font-weight: bold;  font-size: 8pt; "
         txtInteres.Style = "ddo-char-set: 1; text-align: right; font-weight: bold;  font-size: 8pt; "
         txtCapital.Style = "ddo-char-set: 1; text-align: right; font-weight: bold;  font-size: 8pt; "
         txtCapitalAmo.Style = "ddo-char-set: 1; text-align: right; font-weight: bold;  font-size: 8pt; "
         txtCapitalDif.Style = "ddo-char-set: 1; text-align: right; font-weight: bold;  font-size: 8pt; "
         Line3.Visible = True
      Else
         txtCreditoDes.Style = "ddo-char-set: 1; font-size: 8pt; "
         txtCreditoEsp.Style = "ddo-char-set: 1; font-size: 8pt; "
         txtCompraOrden.Style = "ddo-char-set: 1; font-size: 8pt; "
         txtFecha.Style = "ddo-char-set: 1; font-size: 8pt; "
         txtMora.Style = "ddo-char-set: 1; text-align: center; font-size: 8pt; "
         txtInteres.Style = "ddo-char-set: 1; text-align: right; font-size: 8pt; "
         txtCapital.Style = "ddo-char-set: 1; text-align: right; font-size: 8pt; "
         txtCapitalAmo.Style = "ddo-char-set: 1; text-align: right; font-size: 8pt; "
         txtCapitalDif.Style = "ddo-char-set: 1; text-align: right; font-size: 8pt; "
         Line3.Visible = False
      End If
   End Sub
End Class