...
#End Region
   ...
   Private Sub frmProcedencia_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Activated
      Call StatusFormDisplay(Me.Name)
   End Sub

   Private Sub frmProcedencia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
      Dim oCursor As Cursor
      oCursor = Me.Cursor
      Me.Cursor = Cursors.WaitCursor
   ...
   Private Sub grdMainLoad()
      Try
         With moProcedencia
            .SelectFilter = clsProcedencia.SelectFilters.Grid
            .WhereFilter = clsProcedencia.WhereFilters.Grid
            .OrderByFilter = clsProcedencia.OrderByFilters.Grid
   ...
   Private Sub DataShow()
      ...
      Try
         If (grdMain.GetRow.Selected) And (ToLong(grdMain.GetValue("ProcedenciaId")) > 0) Then
            With oProcedencia
               .ProcedenciaId = ToLong(grdMain.GetValue("ProcedenciaId"))
      ...
      Try
         If grdMain.RowCount > 0 Then
            If MessageBox.Show("¿Realmente quiere eliminar el registro?", Me.Text, MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
               With oProcedencia
                  .WhereFilter = clsProcedencia.WhereFilters.PrimaryKey
                  .ProcedenciaId = ToLong(grdMain.GetValue("ProcedenciaId"))
   ...
   Private Sub PrintReport()
      Dim rpt As New rptProcedencia

      rpt.DataSource = GetDataView(moProcedencia.DataSet.Tables(moProcedencia.TableName))

      rpt.lblTitle.Text = "Procedencias"
      rpt.Document.Name = "Procedencias"
      rpt.lblProcedenciaCod.Text = "Código"
      rpt.txtProcedenciaCod.DataField = "ProcedenciaCod"

      rpt.lblProcedenciaDes.Text = "Procedencia"
      rpt.txtProcedenciaDes.DataField = "ProcedenciaDes"
   ...
   Private Sub grdMainFindRow(ByVal lngID As Long)
      ...
      oCol = grdMain.RootTable.Columns("ProcedenciaId")
   ...
   Private Sub FormInit()
      ...
      moProcedencia = New clsProcedencia(clsAppInfo.ConnectString)
   End Sub

   Private Sub grdMainInit()
      With grdMain
         ebrMain.Groups(0).Text = "Procedencias"
         .ContextMenu = mnuMain

         .RootTable.Columns("ProcedenciaId").Visible = False

         .RootTable.Columns("ProcedenciaCod").Caption = "Código"
         .RootTable.Columns("ProcedenciaCod").Width = 150
         .RootTable.Columns("ProcedenciaCod").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("ProcedenciaCod").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("ProcedenciaDes").Caption = "Procedencia"
         .RootTable.Columns("ProcedenciaDes").Width = 300
   ...
   Private Sub frmProcedencia_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmProcedencia_Closed(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Closed
