Public Class frmFacturaDifMultipleEdit
   ...
   Private mlngAlmacenSucursalId As Long
...
#Region " Windows Form Designer generated code "
   ...
   Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmFacturaDifMultipleEdit))
      ...
      Me.KeyPreview = True
      Me.Name = "frmFacturaDifMultipleEdit"
   ...
   Private Sub grdMainLoad()
      ...
      Try
         With moCompra
            ...
            .SelectFilter = clsCompra.SelectFilters.GridFacturaMultiple
            .WhereFilter = clsCompra.WhereFilters.GridFacturaMultiple
...
#Region " Factura "
   ...
   '               If .FindByPK Then
   '                  Dim frm As New frmFacturaDifMultipleDetEdit
            ...
            If GridCheck() Then
               If grdMain.RowCount > 0 Then
                  ...
                  With oFactura
                     ...
                     oFactura.EmpresaId = clsAppInfo.EmpresaId
                     oFactura.GestionId = clsAppInfo.GestionId
                     oFactura.FacturaFecha = ToDateDMY(dtpFecha.Value)
                     oFactura.SucursalId = AlmacenSucursalIdFind(moCompra.AlmacenId)
                     oFactura.TipoFacturaId = 2 'Compra               
                     oFactura.RegRUCDes = ProveedorDesFind(moCompra.ProveedorId, oFactura.NroRUC)
                     oFactura.EstadoId = 11

                     oFactura.SucursalIdOrg = clsAppInfo.SucursalId
                     If clsAppInfo.SucursalApli Then
                        oFactura.SucursalIdOrg = mlngSucursalId
                     End If

                     frm.DataObject = oFactura
                     frm.CompraDataTable = GetDataTableCheck(moCompra.DataSet)
                     frm.MonedaId = 1
                     frm.ProveedorId = moCompra.ProveedorId
                     frm.TipoCambio = ToDecimal(txtTipoCambio.Text)

                     frm.CentroCostoId = 0
                     If clsAppInfo.CentroCostoApli Then
                        frm.CentroCostoId = mlngCentroCostoId
                     End If
   ...
   Private Function GridCheck() As Boolean
      ...
      If (ToDecimal(txtMontoPagBs.Text) <= 0) And (ToDecimal(txtMontoPagUs.Text) <= 0) Then
         GridCheck = False
         Throw New Exception("Debe Seleccionar la(s) Nota(s) de Compra a Facturar")
      End If
      ...
      For Each oRow As Janus.Windows.GridEX.GridEXRow In grdMain.GetRows
         If oRow.Cells("Sel").Value Then
            ...
            If boolFirt Then
               ...
               mlngAlmacenSucursalId = ToLong(oRow.Cells("AlmacenSucursalId").Value)
            ...
            Else
               ...
               If (ToLong(oRow.Cells("AlmacenSucursalId").Value) <> mlngAlmacenSucursalId) Then
                  GridCheck = False
   ...
   Private Sub CompraTotal()
      ...
      For Each oRow As Janus.Windows.GridEX.GridEXRow In grdMain.GetRows
         If oRow.Cells("MonedaId").Value = 1 Then 'Si es Boliviano
            decImporteBs += ToDecimal(oRow.Cells("SaldoFactura").Value)

         ElseIf oRow.Cells("MonedaId").Value = 2 Then
            decImporteUs += ToDecimal(oRow.Cells("SaldoFactura").Value)
         End If
   ...
   Private Sub MontoFacturar()
      ...
      For Each oRow As Janus.Windows.GridEX.GridEXRow In grdMain.GetRows
         ...
         If oRow.Cells("Sel").Value Then
            If oRow.Cells("MonedaId").Value = 1 Then 'Si es Boliviano
               decMontoBs += ToDecimal(oRow.Cells("SaldoFactura").Value)

            ElseIf oRow.Cells("MonedaId").Value = 2 Then
               decMontoUs += ToDecimal(oRow.Cells("SaldoFactura").Value)
            End If
         End If
...
#End Region
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         If clsAppInfo.SucursalApli Then
            ...
            .RootTable.Columns("SucursalDes").EditType = Janus.Windows.GridEX.EditType.NoEdit
            .RootTable.Columns("SucursalDes").FilterEditType = Janus.Windows.GridEX.FilterEditType.TextBox
         ...
         '.RootTable.Columns("SucursalId").Visible = False
         '.RootTable.Columns("SucursalDes").Caption = "Sucursal"
         '.RootTable.Columns("SucursalDes").Width = 80
         '.RootTable.Columns("SucursalDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         '.RootTable.Columns("SucursalDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center

         .RootTable.Columns("AlmacenSucursalId").Visible = False
         .RootTable.Columns("AlmacenSucursalDes").Caption = "Sucursal"
         .RootTable.Columns("AlmacenSucursalDes").Width = 80
         .RootTable.Columns("AlmacenSucursalDes").CellStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Near
         .RootTable.Columns("AlmacenSucursalDes").HeaderStyle.TextAlignment = Janus.Windows.GridEX.TextAlignment.Center
   ...
   Private Sub frmFacturaDifMultipleEdit_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
   ...
   Private Sub frmFacturaDifMultipleEdit_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
      moCompra.Dispose()
      Call ClearMemory()
   End Sub
