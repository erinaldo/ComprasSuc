...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Me.Text = "Pedidos de Compra en tránsito por Almacén"
...
#End Region
   ...
   Private Sub PrintReport()
      ...
      rpt.lblTitle.Text = "Pedidos de compra en tránsito por Almacén"
      rpt.Document.Name = "Pedidos de compra  tránsito por Almacén"
   ...
   Private Sub grdMainInit()
      Dim oAlmacen As New clsAlmacen(clsAppInfo.ConnectString)
      With grdMain
         ebrMain.Groups(0).Text = "Ítem por Almacén"
