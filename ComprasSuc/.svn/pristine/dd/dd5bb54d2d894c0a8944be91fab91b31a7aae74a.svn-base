...
#End Region
      ...
      Try
         If grdMain.RowCount > 0 Then
            If ToLong(grdMain.GetValue("EstadoId")) = 14 Then 'antes 13 
               ...
               End With
            Else
               MessageBox.Show("Imposible Editar La Devolución Sobre Compra", Me.Text, MessageBoxButtons.OK, MessageBoxIcon.Exclamation)
            End If
         Else
   ...
   Private Sub PrintReport()
      ...
      rpt.lblTitle.Text = "Devolución Sobre Compra"
      rpt.Document.Name = "Devolución Sobre Compra"
   ...
   Private Sub grdMainInit()
      With grdMain
         ...
         .RootTable.Columns("CreditoNro").Caption = "Crédito Nro"
