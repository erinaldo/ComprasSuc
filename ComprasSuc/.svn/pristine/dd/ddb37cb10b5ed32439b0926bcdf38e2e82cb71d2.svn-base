Public Class frmProveedorMovResu
...
#Region " Código generado por el Diseñador de Windows Forms "
   ...
   <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(frmProveedorMovResu))
...
#End Region
   ...
   Private Function GetRow() As DataRow
      ...
      If mboolIntervaloFecha Then
         oRow("SaldoAnt") = ProveedorSaldoAnterior(moProveedor.ProveedorId)
         oRow("SaldoFec") = ProveedorSaldoIntervalo(moProveedor.ProveedorId, decHaber, decDebe)
         oRow("DebeFec") = decDebe
         oRow("HaberFec") = decHaber
      Else
         oRow("SaldoAnt") = 0
         oRow("SaldoFec") = ProveedorSaldoActual(moProveedor.ProveedorId, decHaber, decDebe)
         oRow("DebeFec") = decDebe
         oRow("HaberFec") = decHaber
      End If
   ...
   Private Function ProveedorSaldoIntervalo(ByVal lngProveedorId As Long, ByRef decHaber As Decimal, ByRef decDebe As Decimal) As Decimal
      Dim oProveedorMov As New clsProveedorMov(clsAppInfo.ConnectString)
      ''Dim decDebe As Decimal = 0
      ''Dim decHaber As Decimal = 0
   ...
   Private Function ProveedorSaldoActual(ByVal lngProveedorId As Long, ByRef decHaber As Decimal, ByRef decDebe As Decimal) As Decimal
      Dim oProveedorMov As New clsProveedorMov(clsAppInfo.ConnectString)
      ''Dim decDebe As Decimal = 0
      ''Dim decHaber As Decimal = 0
