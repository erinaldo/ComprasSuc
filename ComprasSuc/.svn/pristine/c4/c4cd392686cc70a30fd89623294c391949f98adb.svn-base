...
Public Class clsEmpresaPara
   ...
   Private mbytSucursalApli As Byte
   ...
   Property SucursalApli() As Byte
      Get
         Return mbytSucursalApli
      End Get

      Set(ByVal Value As Byte)
         mbytSucursalApli = Value
      End Set
   End Property
   ...
   Private Function SelectSQL() As String
      ...
      Select Case mintSelectFilter
         Case SelectFilters.All
            ...
            strSQL &= "    tblEmpresaPara.SucursalApli,  "
   ...
   Private Function InsertSQL() As String
      ...
      Select Case mintInsertFilter
         Case InsertFilters.All
            ...
            strSQL &= NumberToField(mbytSucursalApli) & ", "
   ...
   Private Function UpdateSQL() As String
      ...
      Select Case mintUpdateFilter
         Case UpdateFilters.All
            ...
            strSQL &= "SucursalApli = " & NumberToField(mbytSucursalApli) & ", "
      ...
      Try
         ...
         Select Case mintSelectFilter
            Case SelectFilters.All
               ...
               mbytSucursalApli = ToByte(oDataRow("SucursalApli"))
      ...
      Try
         If Validate() Then
            If NoDuplicates(False) Then
               ...
               End If
            Else
               Throw New Exception("Registro Duplicado, Ya Existe una Empresa con ese Número de Orden y Código Alfanumérico")
               Return False
            End If
         End If
